...
import kotlinx.android.synthetic.main.alert_layout_activity_fragment.*

class FragmentAlertActivity : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.alert_layout_activity_fragment, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        logout_alert.setOnClickListener {
            logoutUser()
        }
    }
    ...
    private fun dataUser(){
        ...
        nama_user_alert.text = "Selamat Datang $name"
        view?.let { Glide.with(it).load(image).into(image_profile_alert) }
    }
