...
//
//     final lapPusdatinProdGas = lapPusdatinProdGasFromJson(jsonString);

import 'dart:convert';

LapPusdatinProdGas lapPusdatinProdGasFromJson(String str) => LapPusdatinProdGas.fromJson(json.decode(str));

String lapPusdatinProdGasToJson(LapPusdatinProdGas data) => json.encode(data.toJson());

class LapPusdatinProdGas {
    String idLaporan;
    ...
    factory LapPusdatinProdGas.fromJson(Map<String, dynamic> json) => new LapPusdatinProdGas(
