package com.example.esdm.Geologi;
...
import com.example.esdm.Geologi.GeoApi.Adapter;
import com.example.esdm.Geologi.GeoApi.Model;
import com.example.esdm.Geologi.GeoBumi.Adapter2;
import com.example.esdm.Geologi.GeoBumi.Model2;
import com.example.esdm.Geologi.GeoTanah.Adapter3;
import com.example.esdm.Geologi.GeoTanah.Model3;
...
public class GeologiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_geologi);

        gunung_api = (Button) findViewById(R.id.btn1);
        gerakan_tanah = (Button) findViewById(R.id.btn2);
        gempa_bumi = (Button) findViewById(R.id.btn3);
    ...
    private void parseJSON() {
        String url = "http://172.16.23.34/laporan-harian-esdm/api/Lap_geologi_last_date";
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            mExampleAdapter1 = new Adapter(GeologiActivity.this, mExampleList);
                            mRecyclerView1.setAdapter(mExampleAdapter1);
                        ...
                        try {
                            ...
                            mExampleAdapter2 = new Adapter2(GeologiActivity.this, mExampleList2);
                            mRecyclerView2.setAdapter(mExampleAdapter2);
                        ...
                        try {
                            ...
                            mExampleAdapter3 = new Adapter3(GeologiActivity.this, mExampleList3);
                            mRecyclerView3.setAdapter(mExampleAdapter3);
