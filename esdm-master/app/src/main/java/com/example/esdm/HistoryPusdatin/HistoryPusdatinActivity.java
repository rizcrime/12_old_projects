package com.example.esdm.HistoryPusdatin;
...
import com.example.esdm.HistoryPusdatin.BeritaOpec.Adapter8;
import com.example.esdm.HistoryPusdatin.BeritaOpec.Model8;
import com.example.esdm.HistoryPusdatin.HargaBatubara.Adapter9;
import com.example.esdm.HistoryPusdatin.HargaBatubara.Model9;
import com.example.esdm.HistoryPusdatin.HargaBbm.Adapter6;
import com.example.esdm.HistoryPusdatin.HargaBbm.Model6;
import com.example.esdm.HistoryPusdatin.HargaMineral.Adapter10;
import com.example.esdm.HistoryPusdatin.HargaMineral.Model10;
import com.example.esdm.HistoryPusdatin.Icp.Adapter2;
import com.example.esdm.HistoryPusdatin.Icp.Model2;
import com.example.esdm.HistoryPusdatin.LiftingTahun.Adapter5;
import com.example.esdm.HistoryPusdatin.LiftingTahun.Model5;
import com.example.esdm.HistoryPusdatin.PenyaluranPremium.Adapter7;
import com.example.esdm.HistoryPusdatin.PenyaluranPremium.Model7;
import com.example.esdm.HistoryPusdatin.ProdEkuivalen.Adapter4;
import com.example.esdm.HistoryPusdatin.ProdEkuivalen.Model4;
import com.example.esdm.HistoryPusdatin.ProdGas.Adapter3;
import com.example.esdm.HistoryPusdatin.ProdGas.Model3;
import com.example.esdm.HistoryPusdatin.ProdMinyak.Adapter;
import com.example.esdm.HistoryPusdatin.ProdMinyak.Model;
import com.example.esdm.HistoryPusdatin.StatusKetenagalistrikan.Adapter11;
import com.example.esdm.HistoryPusdatin.StatusKetenagalistrikan.Model11;
...
public class HistoryPusdatinActivity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ScrollView rootView = (ScrollView) inflater.inflate(R.layout.activity_pusdatin, container, false);

        prodminyak = rootView.findViewById(R.id.btn1);
        icp = rootView.findViewById(R.id.btn2);
        prodgas = rootView.findViewById(R.id.btn3);
        prodekuivalen = rootView.findViewById(R.id.btn4);
        liftingtahun = rootView.findViewById(R.id.btn5);
        hargabbm = rootView.findViewById(R.id.btn6);
        progrespenyaluran = rootView.findViewById(R.id.btn7);
        beritaopec = rootView.findViewById(R.id.btn8);
        hargabatubara = rootView.findViewById(R.id.btn9);
        hargamineral = rootView.findViewById(R.id.btn10);
        status = rootView.findViewById(R.id.btn11);
        ...
        layar4 = rootView.findViewById(R.id.layout4);
        layar5 = rootView.findViewById(R.id.layout5);
        layar6 = rootView.findViewById(R.id.layout6);
        layar7 = rootView.findViewById(R.id.layout7);
        layar8 = rootView.findViewById(R.id.layout8);
        layar9 = rootView.findViewById(R.id.layout9);
        layar10 = rootView.findViewById(R.id.layout10);
        layar11 = rootView.findViewById(R.id.layout11);
        ...
        mRecyclerView4 = rootView.findViewById(R.id.recycler4);
        mRecyclerView5 = rootView.findViewById(R.id.recycler5);
        mRecyclerView6 = rootView.findViewById(R.id.recycler6);
        mRecyclerView7 = rootView.findViewById(R.id.recycler7);
        mRecyclerView8 = rootView.findViewById(R.id.recycler8);
        mRecyclerView9 = rootView.findViewById(R.id.recycler9);
        mRecyclerView10 = rootView.findViewById(R.id.recycler10);
        mRecyclerView11 = rootView.findViewById(R.id.recycler11);
        ...
        mRecyclerView6.setLayoutManager(new LinearLayoutManager(getActivity()));

        mRecyclerView7.setHasFixedSize(true);
        mRecyclerView7.setLayoutManager(new LinearLayoutManager(getActivity()));

        mRecyclerView8.setHasFixedSize(true);
        mRecyclerView8.setLayoutManager(new LinearLayoutManager(getActivity()));

        mRecyclerView9.setHasFixedSize(true);
        mRecyclerView9.setLayoutManager(new LinearLayoutManager(getActivity()));

        mRecyclerView10.setHasFixedSize(true);
        mRecyclerView10.setLayoutManager(new LinearLayoutManager(getActivity()));

        mRecyclerView11.setHasFixedSize(true);
        mRecyclerView11.setLayoutManager(new LinearLayoutManager(getActivity()));
        ...
        tvDateResult4 = (EditText) rootView.findViewById(R.id.tv_dateresult4);
        btDatePicker4 = (ImageView) rootView.findViewById(R.id.bt_datepicker4);
        ...
        tvDateResult5 = (EditText) rootView.findViewById(R.id.tv_dateresult5);
        btDatePicker5 = (ImageView) rootView.findViewById(R.id.bt_datepicker5);
        ...
        tvDateResult6 = (EditText) rootView.findViewById(R.id.tv_dateresult6);
        btDatePicker6 = (ImageView) rootView.findViewById(R.id.bt_datepicker6);
        ...
        tvDateResult7 = (EditText) rootView.findViewById(R.id.tv_dateresult7);
        btDatePicker7 = (ImageView) rootView.findViewById(R.id.bt_datepicker7);
        ...
        tvDateResult8 = (EditText) rootView.findViewById(R.id.tv_dateresult8);
        btDatePicker8 = (ImageView) rootView.findViewById(R.id.bt_datepicker8);
        ...
        tvDateResult9 = (EditText) rootView.findViewById(R.id.tv_dateresult9);
        btDatePicker9 = (ImageView) rootView.findViewById(R.id.bt_datepicker9);
        ...
        tvDateResult10 = (EditText) rootView.findViewById(R.id.tv_dateresult10);
        btDatePicker10 = (ImageView) rootView.findViewById(R.id.bt_datepicker10);
        ...
        tvDateResult11 = (EditText) rootView.findViewById(R.id.tv_dateresult11);
        btDatePicker11 = (ImageView) rootView.findViewById(R.id.bt_datepicker11);
...
//                filter(s.toString());
    ...
    private void showDateDialog4(){
        Calendar newCalendar = Calendar.getInstance();
        datePickerDialog4 = new DatePickerDialog(getActivity(), new DatePickerDialog.OnDateSetListener() {
    ...
    private void showDateDialog5(){
        Calendar newCalendar = Calendar.getInstance();
        datePickerDialog5 = new DatePickerDialog(getActivity(), new DatePickerDialog.OnDateSetListener() {
    ...
    private void showDateDialog6(){
        Calendar newCalendar = Calendar.getInstance();
        datePickerDialog6 = new DatePickerDialog(getActivity(), new DatePickerDialog.OnDateSetListener() {
    ...
    private void showDateDialog7(){
        Calendar newCalendar = Calendar.getInstance();
        datePickerDialog7 = new DatePickerDialog(getActivity(), new DatePickerDialog.OnDateSetListener() {
    ...
    private void showDateDialog8(){
        Calendar newCalendar = Calendar.getInstance();
        datePickerDialog8 = new DatePickerDialog(getActivity(), new DatePickerDialog.OnDateSetListener() {
    ...
    private void showDateDialog9(){
        Calendar newCalendar = Calendar.getInstance();
        datePickerDialog9 = new DatePickerDialog(getActivity(), new DatePickerDialog.OnDateSetListener() {
    ...
    private void showDateDialog10(){
        Calendar newCalendar = Calendar.getInstance();
        datePickerDialog10 = new DatePickerDialog(getActivity(), new DatePickerDialog.OnDateSetListener() {
    ...
    private void showDateDialog11(){
        Calendar newCalendar = Calendar.getInstance();
        datePickerDialog11 = new DatePickerDialog(getActivity(), new DatePickerDialog.OnDateSetListener() {
    ...
    private void parseJSON() {
        String url = "http://172.16.23.34/laporan-harian-esdm/api/lap_pusdatin";
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            mExampleAdapter4 = new Adapter4(getActivity(), mExampleList4);
                            mRecyclerView4.setAdapter(mExampleAdapter4);
                        ...
                        try {
                            ...
                            mExampleAdapter5 = new Adapter5(getActivity(), mExampleList5);
                            mRecyclerView5.setAdapter(mExampleAdapter5);
                        ...
                        try {
                            ...
                            mExampleAdapter6 = new Adapter6(getActivity(), mExampleList6);
                            mRecyclerView6.setAdapter(mExampleAdapter6);
                        ...
                        try {
                            ...
                            mExampleAdapter7 = new Adapter7(getActivity(), mExampleList7);
                            mRecyclerView7.setAdapter(mExampleAdapter7);
                        ...
                        try {
                            ...
                            mExampleAdapter8 = new Adapter8(getActivity(), mExampleList8);
                            mRecyclerView8.setAdapter(mExampleAdapter8);
                        ...
                        try {
                            ...
                            mExampleAdapter9 = new Adapter9(getActivity(), mExampleList9);
                            mRecyclerView9.setAdapter(mExampleAdapter9);
                        ...
                        try {
                            ...
                            mExampleAdapter10 = new Adapter10(getActivity(), mExampleList10);
                            mRecyclerView10.setAdapter(mExampleAdapter10);
                        ...
                        try {
                            ...
                            mExampleAdapter11 = new Adapter11(getActivity(), mExampleList11);
                            mRecyclerView11.setAdapter(mExampleAdapter11);
