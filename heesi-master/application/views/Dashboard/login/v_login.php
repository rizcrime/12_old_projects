...
<body class="bg-gradient-primary">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-xl-6 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body-p0" align="center">
            <!-- Nested Row within Card Body -->
              <div class="col-lg-9" align="center">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900"><b>SIPATUH</b></h1><h5 class="text-gray-900 mb-4">Haji Khusus</h5>
                  </div>
  ...
  <!-- <p class="text-white text-center" style="font-size: 11pt; margin-top: -40px;">Kementerian Agama Republik Indonesia</p> -->
