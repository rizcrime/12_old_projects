...
import com.simwaspihk.admin.fragment.AdminFragment;
...
public class AdminActivity extends AppCompatActivity implements OnSliderClickListener, OnPageChangeListener {
    ...
    private void loadDevHomeFragment() {
        ...
        Runnable mPendingRunnable = new Runnable() {
            public void run() {
                Fragment fragment = AdminActivity.this.getDevHomeFragment();
                FragmentTransaction fragmentTransaction = AdminActivity.this.getSupportFragmentManager().beginTransaction();
                fragmentTransaction.setCustomAnimations(17432576, 17432577);
                fragmentTransaction.replace(R.id.frame, fragment, AdminActivity.CURRENT_TAG);
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.home /*2131689476*/:
                        AdminActivity.navItemIndex = 0;
                        AdminActivity.CURRENT_TAG = AdminActivity.TAG_HOME;
                        break;
                    case R.id.nav_profile /*2131689985*/:
                        AdminActivity.this.startActivity(new Intent(AdminActivity.this, ProfileDataActivity.class));
                        break;
                    case R.id.nav_chat /*2131689986*/:
                        Toast.makeText(AdminActivity.this, "Messenger Masih dalam Proses! :)", 0).show();
                        break;
                    case R.id.nav_sakit /*2131689987*/:
                        AdminActivity.this.startActivity(new Intent(AdminActivity.this, TbsakitActivity.class));
                        break;
                    case R.id.nav_wafat /*2131689988*/:
                        AdminActivity.this.startActivity(new Intent(AdminActivity.this, TbwafatActivity.class));
                        break;
                    case R.id.nav_privacy_policy /*2131689989*/:
                        AdminActivity.this.drawer.closeDrawers();
                        break;
                    default:
                        AdminActivity.navItemIndex = 0;
                        break;
                ...
                menuItem.setChecked(true);
                AdminActivity.this.loadDevHomeFragment();
                AdminActivity.this.drawer.closeDrawers();
                return true;
            }
        });
