...
import com.simwaspihk.activity.bottomNavigation.BottomNavigationActivity;
...
public class DevMainActivity extends AppCompatActivity implements OnSliderClickListener, OnPageChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView((int) R.layout.dev_activity_main);
        ...
        tabLayout.addTab(tabLayout.newTab().setText((CharSequence) "DATA"));
    ...
    private void loadDevHomeFragment() {
        ...
        Runnable mPendingRunnable = new Runnable() {
            public void run() {
                Fragment fragment = DevMainActivity.this.getDevHomeFragment();
                FragmentTransaction fragmentTransaction = DevMainActivity.this.getSupportFragmentManager().beginTransaction();
                fragmentTransaction.setCustomAnimations(R.anim.fade_in, R.anim.fade_out);
                fragmentTransaction.replace(R.id.frame, fragment, DevMainActivity.CURRENT_TAG);
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.home /*2131689476*/:
                        DevMainActivity.navItemIndex = 0;
                        DevMainActivity.CURRENT_TAG = DevMainActivity.TAG_HOME;
                        break;
                    case R.id.nav_profile /*2131689985*/:
                        DevMainActivity.this.startActivity(new Intent(DevMainActivity.this, ProfileDataActivity.class));
                        break;
                    case R.id.nav_chat /*2131689986*/:
                        Toast.makeText(DevMainActivity.this, "Messenger Masih dalam Proses! :)", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.nav_sakit /*2131689987*/:
                        DevMainActivity.this.startActivity(new Intent(DevMainActivity.this, TbsakitActivity.class));
                        break;
                    case R.id.nav_wafat /*2131689988*/:
                        DevMainActivity.this.startActivity(new Intent(DevMainActivity.this, TbwafatActivity.class));
                        break;
                    case R.id.nav_privacy_policy /*2131689989*/:
                        DevMainActivity.this.startActivity(new Intent(DevMainActivity.this, BottomNavigationActivity.class));
                        break;
                    default:
                        DevMainActivity.navItemIndex = 0;
                        break;
                ...
                menuItem.setChecked(true);
                DevMainActivity.this.drawer.closeDrawers();
                return true;
            }
        });
