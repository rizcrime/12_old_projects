...
public class BottomNavigationBar implements OnClickListener {
    ...
    public BottomNavigationBar(Context mContext, List<NavigationPage> pages, BottomNavigationMenuClickListener listener) {
        ...
        this.mViewBar1 = this.mActivity.findViewById(R.id.viewBar1);
        this.mViewBar2 = this.mActivity.findViewById(R.id.viewBar2);
        this.mViewBar3 = this.mActivity.findViewById(R.id.viewBar3);
        this.mViewBar4 = this.mActivity.findViewById(R.id.viewBar4);
    ...
    private void setView(View view) {
        ...
        if (view.getId() == R.id.linearLayoutBar1) {
            ...
            this.mImageViewBar1.setColorFilter(ContextCompat.getColor(this.mContext, R.color.colorNavAccentSelected));
            this.mTextViewBar1.setTextColor(ContextCompat.getColor(this.mContext, R.color.colorNavAccentSelected));
        } else if (view.getId() == R.id.linearLayoutBar2) {
