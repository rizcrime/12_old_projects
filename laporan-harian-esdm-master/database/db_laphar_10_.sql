...
--
-- Table structure for table `r_lap_berita_hot_news`
--

CREATE TABLE `r_lap_berita_hot_news` (
  ...
  `CATATAN_REVIEW` varchar(300) DEFAULT NULL,
  `HAS_REVIEW` char(1) DEFAULT NULL,
  `TANGGAL_REVIEW` datetime DEFAULT NULL,
  `USER_REVIEW` int(1) DEFAULT NULL,
  `FLATFORM_REVIEW` varchar(30) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `r_lap_berita_hot_news`
--

INSERT INTO `r_lap_berita_hot_news` (`ID_LAPORAN`, `TANGGAL_LAPORAN`, `BERITA`, `JENIS`, `URL`, `IS_POST`, `USER_ENTRY`, `TANGGAL_ENTRY`, `FLATFORM_ENTRY`, `USER_POST`, `TANGGAL_POST`, `FLATFORM_POST`, `IMAGE`, `CATATAN_REVIEW`, `HAS_REVIEW`, `TANGGAL_REVIEW`, `USER_REVIEW`, `FLATFORM_REVIEW`) VALUES
(33, '2019-07-31', 'Tester', NULL, 'www.w3schools.com/php/func_string_str_pad.asp', NULL, 14, '2019-08-01 14:08:23', 'WEB', NULL, NULL, NULL, 'bg_content.PNG', NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `r_lap_berita_negatif`
--

CREATE TABLE `r_lap_berita_negatif` (
  `ID_LAPORAN` int(11) NOT NULL,
  `TANGGAL_LAPORAN` date DEFAULT NULL,
  `BERITA` text,
  `JENIS` char(1) DEFAULT NULL,
...
--
-- Dumping data for table `r_lap_berita_negatif`
--

INSERT INTO `r_lap_berita_negatif` (`ID_LAPORAN`, `TANGGAL_LAPORAN`, `BERITA`, `JENIS`, `URL`, `IS_POST`, `USER_ENTRY`, `TANGGAL_ENTRY`, `FLATFORM_ENTRY`, `USER_POST`, `TANGGAL_POST`, `FLATFORM_POST`, `IMAGE`, `CATATAN_REVIEW`, `HAS_REVIEW`, `TANGGAL_REVIEW`, `USER_REVIEW`, `FLATFORM_REVIEW`) VALUES
(1, '2019-07-14', 'tes', NULL, 'www.co.id', NULL, 2, '2019-07-15 16:07:48', 'WEB', NULL, NULL, NULL, 'https://media.suara.com/pictures/653x366/2018/12/03/73014-tugu-monas.jpg', NULL, NULL, NULL, NULL, NULL),
(2, '2019-07-16', 'kuli', NULL, 'https://www.tabloidbintang.com/berita/peristiwa/read/105163/putranya-lulus-sbmptn-2018-dewinta-bahar-bahagia-bercampur-sedih', NULL, 2, '2019-07-17 13:07:38', 'WEB', NULL, NULL, NULL, 'default.jpg', NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `r_lap_berita_netral`
--

CREATE TABLE `r_lap_berita_netral` (
  `ID_LAPORAN` int(11) NOT NULL,
  `TANGGAL_LAPORAN` date DEFAULT NULL,
  `BERITA` text,
  `JENIS` char(1) DEFAULT NULL,
...
--
-- Dumping data for table `r_lap_berita_netral`
--

INSERT INTO `r_lap_berita_netral` (`ID_LAPORAN`, `TANGGAL_LAPORAN`, `BERITA`, `JENIS`, `URL`, `IS_POST`, `USER_ENTRY`, `TANGGAL_ENTRY`, `FLATFORM_ENTRY`, `USER_POST`, `TANGGAL_POST`, `FLATFORM_POST`, `CATATAN_REVIEW`, `HAS_REVIEW`, `TANGGAL_REVIEW`, `USER_REVIEW`, `FLATFORM_REVIEW`) VALUES
(1, '2019-07-17', 'Aku Cinta Kamu', NULL, 'www.cinta.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `r_lap_berita_positif`
--

CREATE TABLE `r_lap_berita_positif` (
  `ID_LAPORAN` int(11) NOT NULL,
  `TANGGAL_LAPORAN` date DEFAULT NULL,
  `BERITA` text,
  `JENIS` char(1) DEFAULT NULL,
...
--
-- Table structure for table `r_lap_geologi_gempa_bumi`
--

CREATE TABLE `r_lap_geologi_gempa_bumi` (
  `ID_LAPORAN` int(11) NOT NULL,
  `TANGGAL_LAPORAN` date DEFAULT NULL,
  `LOKASI` text,
  `INFORMASI` text,
...
--
-- Dumping data for table `r_lap_geologi_gempa_bumi`
--

INSERT INTO `r_lap_geologi_gempa_bumi` (`ID_LAPORAN`, `TANGGAL_LAPORAN`, `LOKASI`, `INFORMASI`, `KONDISI_GEOLOGI_DT`, `PENYEBAB_GEMPA`, `DAMPAK_GEMPA`, `REKOMENDASI`, `IS_POST`, `USER_ENTRY`, `TANGGAL_ENTRY`, `FLATFORM_ENTRY`, `USER_POST`, `TANGGAL_POST`, `FLATFORM_POST`, `CATATAN_REVIEW`, `HAS_REVIEW`, `TANGGAL_REVIEW`, `USER_REVIEW`, `FLATFORM_REVIEW`) VALUES
(1, '2019-05-12', 'Gempa bumi di baratlaut Daruba, Maluku Utara', 'Gempa bumi terjadi pada hari Rabu, 24 April 2019, pukul 09:17:20 WIB. Berdasarkan\r\ninformasi dari BMKG, pusat gempa bumi terletak pada koordinat 2.29°LU dan 128.15°BT,\r\ndengan magnitudo 5.2 pada kedalaman 100 km, berjarak 31 km BaratLaut Daruba, Maluku Utara.\r\n', 'Wilayah yang berdekatan dengan pusat gempa bumi pada umumnya tersusun oleh batuan\r\nvulkanik berumur Pra Tersier, dimana sebagian batuan telah mengalami pelapukan. Batuan\r\nyang telah mengalami pelapukan tersebut dapat memperkuat efek guncangan gempa bumi.\r\n', 'Wilayah yang berdekatan dengan pusat gempa bumi pada umumnya tersusun oleh batuan\r\nvulkanik berumur Pra Tersier, dimana sebagian batuan telah mengalami pelapukan. Batuan\r\nyang telah mengalami pelapukan tersebut dapat memperkuat efek guncangan gempa bumi.\r\n', NULL, 'Wilayah yang berdekatan dengan pusat gempa bumi pada umumnya tersusun oleh batuan\r\nvulkanik berumur Pra Tersier, dimana sebagian batuan telah mengalami pelapukan. Batuan\r\nyang telah mengalami pelapukan tersebut dapat memperkuat efek guncangan gempa bumi.\r\n', 'Y', 2, '2019-05-12 01:05:32', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, '2019-05-13', 'Wilayah yang berdekatan dengan pusat gempa bumi pada umumnya tersusun oleh batuan\r\nvulkanik berumur Pra Tersier, dimana sebagian batuan telah mengalami pelapukan. Batuan\r\nyang telah mengalami pelapukan tersebut dapat memperkuat efek guncangan gempa bumi.\r\n', 'Wilayah yang berdekatan dengan pusat gempa bumi pada umumnya tersusun oleh batuan\r\nvulkanik berumur Pra Tersier, dimana sebagian batuan telah mengalami pelapukan. Batuan\r\nyang telah mengalami pelapukan tersebut dapat memperkuat efek guncangan gempa bumi.\r\n', 'Wilayah yang berdekatan dengan pusat gempa bumi pada umumnya tersusun oleh batuan\r\nvulkanik berumur Pra Tersier, dimana sebagian batuan telah mengalami pelapukan. Batuan\r\nyang telah mengalami pelapukan tersebut dapat memperkuat efek guncangan gempa bumi.\r\n', 'Wilayah yang berdekatan dengan pusat gempa bumi pada umumnya tersusun oleh batuan\r\nvulkanik berumur Pra Tersier, dimana sebagian batuan telah mengalami pelapukan. Batuan\r\nyang telah mengalami pelapukan tersebut dapat memperkuat efek guncangan gempa bumi.\r\n', NULL, 'Wilayah yang berdekatan dengan pusat gempa bumi pada umumnya tersusun oleh batuan\r\nvulkanik berumur Pra Tersier, dimana sebagian batuan telah mengalami pelapukan. Batuan\r\nyang telah mengalami pelapukan tersebut dapat memperkuat efek guncangan gempa bumi.\r\n', 'Y', 2, '2019-05-12 03:05:07', 'WEB', 2, '2019-05-12 03:05:46', 'WEB', NULL, NULL, NULL, NULL, NULL),
(3, '2019-06-14', 'Jogja', 'Ya lumayan', 'Rungsek', 'Tanah goyang', 'Ratusan rumah rusak', 'Segera Mengungsi', 'Y', 2, '2019-06-15 22:06:18', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, '2019-07-13', 'asdsa', 'qwe', 'asd', 'erte', 'qw', 'ad', 'Y', 2, '2019-07-14 16:07:50', 'WEB', 2, '2019-07-18 18:07:57', 'WEB', NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `r_lap_geologi_gerakan_tanah`
--

CREATE TABLE `r_lap_geologi_gerakan_tanah` (
  `ID_LAPORAN` int(11) NOT NULL,
  `TANGGAL_LAPORAN` date DEFAULT NULL,
  `KETERANGAN` text,
  `DETAIL` text,
...
--
-- Dumping data for table `r_lap_klik_ebtke`
--
...
--
-- Table structure for table `r_lap_klik_gatrik`
--

CREATE TABLE `r_lap_klik_gatrik` (
  `ID_LAPORAN` int(11) NOT NULL,
  `TANGGAL_LAPORAN` date DEFAULT NULL,
  `BERITA` text,
...
--
-- Dumping data for table `r_lap_klik_gatrik`
--
...
--
-- Table structure for table `r_lap_klik_geologi`
--

CREATE TABLE `r_lap_klik_geologi` (
  `ID_LAPORAN` int(11) NOT NULL,
  `TANGGAL_LAPORAN` date DEFAULT NULL,
  `BERITA` text,
  `JENIS` char(1) DEFAULT NULL,
...
--
-- Dumping data for table `r_lap_klik_geologi`
--
...
--
-- Table structure for table `r_lap_klik_migas`
--

CREATE TABLE `r_lap_klik_migas` (
  `ID_LAPORAN` int(11) NOT NULL,
  `TANGGAL_LAPORAN` date DEFAULT NULL,
  `BERITA` text,
  `JENIS` char(1) DEFAULT NULL,
...
--
-- Dumping data for table `r_lap_klik_migas`
--
...
(4, '2019-06-08', 'testis', 'N', 'okok', NULL, 2, '2019-06-09 10:06:09', 'WEB', NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `r_lap_klik_minerba`
--

CREATE TABLE `r_lap_klik_minerba` (
  `ID_LAPORAN` int(11) NOT NULL,
  `TANGGAL_LAPORAN` date DEFAULT NULL,
  `BERITA` text,
  `JENIS` char(1) DEFAULT NULL,
...
--
-- Dumping data for table `r_lap_klik_minerba`
--
...
--
-- Table structure for table `r_lap_pusdatin_berita_opec_harian`
--

CREATE TABLE `r_lap_pusdatin_berita_opec_harian` (
  `ID_LAPORAN` int(11) NOT NULL,
  `TANGGAL_LAPORAN` date DEFAULT NULL,
  `BERITA` text,
  `IS_POST` char(1) DEFAULT NULL,
...
--
-- Dumping data for table `r_lap_pusdatin_berita_opec_harian`
--

INSERT INTO `r_lap_pusdatin_berita_opec_harian` (`ID_LAPORAN`, `TANGGAL_LAPORAN`, `BERITA`, `IS_POST`, `USER_ENTRY`, `TANGGAL_ENTRY`, `FLATFORM_ENTRY`, `USER_POST`, `TANGGAL_POST`, `FLATFORM_POST`, `CATATAN_REVIEW`, `HAS_REVIEW`, `TANGGAL_REVIEW`, `USER_REVIEW`, `FLATFORM_REVIEW`) VALUES
(2, '2019-05-10', 'gdddd', 'Y', 1, '2019-05-10 12:05:10', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, '2019-07-21', 'SDFDSFSD', 'Y', 2, '2019-07-21 14:07:56', 'WEB', 9, '2019-07-23 14:07:46', 'WEB', NULL, NULL, NULL, NULL, NULL),
(4, '2019-07-22', 'yo', NULL, 11, '2019-07-23 14:07:08', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(5, '2019-07-22', 'tessssssssssss', NULL, 11, '2019-07-23 16:07:49', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(6, '2019-07-22', 'Berita ku', NULL, 11, '2019-07-23 22:07:16', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(7, '2019-07-23', 'Berita kepada kawan', NULL, 11, '2019-07-24 10:07:44', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(8, '2019-07-23', 'Beritaku', 'Y', 11, '2019-07-24 14:07:59', 'WEB', 9, '2019-07-24 17:07:37', 'WEB', NULL, 'Y', '2019-07-24 17:07:04', 7, 'WEB');

-- --------------------------------------------------------

--
-- Table structure for table `r_lap_pusdatin_harga_bbm`
--

CREATE TABLE `r_lap_pusdatin_harga_bbm` (
  `ID_LAPORAN` int(11) NOT NULL,
  `TANGGAL_LAPORAN` date DEFAULT NULL,
  `JENIS_TERTENTU` text,
  `BBM_UMUM` text,
...
--
-- Dumping data for table `r_lap_pusdatin_harga_bbm`
--

INSERT INTO `r_lap_pusdatin_harga_bbm` (`ID_LAPORAN`, `TANGGAL_LAPORAN`, `JENIS_TERTENTU`, `BBM_UMUM`, `PROG_IND_SATU_HRG`, `HARGA_PERNEGARA`, `IS_POST`, `USER_ENTRY`, `TANGGAL_ENTRY`, `FLATFORM_ENTRY`, `USER_POST`, `TANGGAL_POST`, `FLATFORM_POST`, `CATATAN_REVIEW`, `HAS_REVIEW`, `TANGGAL_REVIEW`, `USER_REVIEW`, `FLATFORM_REVIEW`) VALUES
(1, '2019-05-10', 'Tet', 'test', 'etet', 'tttt', 'Y', 1, '2019-05-10 12:05:59', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, '1970-01-01', 'TEST tertentu', 'TEST Umum', 'Satu Harga', '19997', NULL, 2, '2019-07-23 08:07:30', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, '1970-01-01', 'TEST tertentu', 'TEST Umum', 'Satu Harga', '19997', NULL, 2, '2019-07-23 08:07:34', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, '1970-01-01', 'Test Tertentu', 'umum', 'satu harga', '20000', NULL, 2, '2019-07-23 08:07:07', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(5, NULL, 'Test Tertentu', 'umum', 'satu harga', '20000', NULL, 2, '2019-07-23 08:07:19', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(6, '2019-07-22', 'tertentu', 'umum', 'satu harga', '1367654', NULL, 2, '2019-07-23 08:07:46', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(7, '2019-07-22', 'Tertentu', 'Umum', 'Satu Harga', '23456', NULL, 2, '2019-07-23 09:07:59', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(8, '2019-07-22', 'Tertentu', 'Umum', '1 Harga', '222222', NULL, 2, '2019-07-23 09:07:20', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(9, '2019-07-22', 'T tertentu ', 'J umum', 'BBM 1 Harga', '200000', NULL, 11, '2019-07-23 13:07:29', 'WEB', NULL, NULL, NULL, NULL, 'Y', '2019-07-23 14:07:16', 7, 'WEB'),
(10, '2019-07-22', 'Tentu', 'Umum', 'Tes 1 harga', '200001', NULL, 2, '2019-07-23 16:07:21', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(11, '2019-07-22', 'yaya', 'tetes', 'kata', '2000000123', NULL, 11, '2019-07-23 16:07:22', 'WEB', NULL, NULL, NULL, 'ganti tu', NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `r_lap_pusdatin_harga_bb_acuan`
--

CREATE TABLE `r_lap_pusdatin_harga_bb_acuan` (
  `ID_LAPORAN` int(11) NOT NULL,
  `TANGGAL_LAPORAN` date DEFAULT NULL,
  `HARGA` text,
  `SUMBER` text,
...
--
-- Dumping data for table `r_lap_pusdatin_harga_bb_acuan`
--

INSERT INTO `r_lap_pusdatin_harga_bb_acuan` (`ID_LAPORAN`, `TANGGAL_LAPORAN`, `HARGA`, `SUMBER`, `IS_POST`, `USER_ENTRY`, `TANGGAL_ENTRY`, `FLATFORM_ENTRY`, `USER_POST`, `TANGGAL_POST`, `FLATFORM_POST`, `CATATAN_REVIEW`, `HAS_REVIEW`, `TANGGAL_REVIEW`, `USER_REVIEW`, `FLATFORM_REVIEW`) VALUES
(2, '2019-05-10', 'Ter', 'SSSS', 'Y', 1, '2019-05-10 12:05:06', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, '2019-07-17', '222222', '', NULL, 2, '2019-07-18 16:07:07', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, '2019-07-23', '20000000', 'test', NULL, 11, '2019-07-24 17:07:04', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `r_lap_pusdatin_harga_mineral_acuan`
--

CREATE TABLE `r_lap_pusdatin_harga_mineral_acuan` (
  `ID_LAPORAN` int(11) NOT NULL,
  `TANGGAL_LAPORAN` date DEFAULT NULL,
  `HARGA` text,
  `SUMBER` text,
...
--
-- Dumping data for table `r_lap_pusdatin_harga_mineral_acuan`
--

INSERT INTO `r_lap_pusdatin_harga_mineral_acuan` (`ID_LAPORAN`, `TANGGAL_LAPORAN`, `HARGA`, `SUMBER`, `IS_POST`, `USER_ENTRY`, `TANGGAL_ENTRY`, `FLATFORM_ENTRY`, `USER_POST`, `TANGGAL_POST`, `FLATFORM_POST`, `CATATAN_REVIEW`, `HAS_REVIEW`, `TANGGAL_REVIEW`, `USER_REVIEW`, `FLATFORM_REVIEW`) VALUES
(3, '2019-05-10', 'GG', 'ggg', 'Y', 1, '2019-05-10 12:05:55', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `r_lap_pusdatin_icp`
--

CREATE TABLE `r_lap_pusdatin_icp` (
  `ID_LAPORAN` int(11) NOT NULL,
  `TANGGAL_LAPORAN` date DEFAULT NULL,
...
--
-- Dumping data for table `r_lap_pusdatin_icp`
--

INSERT INTO `r_lap_pusdatin_icp` (`ID_LAPORAN`, `TANGGAL_LAPORAN`, `KETERANGAN`, `PROD_01`, `PROD_02`, `PROD_03`, `PROD_04`, `PROD_05`, `PROD_06`, `PROD_07`, `PROD_08`, `PROD_09`, `PROD_10`, `PROD_11`, `PROD_12`, `PROD_TAHUNAN`, `APBN`, `IS_POST`, `USER_ENTRY`, `TANGGAL_ENTRY`, `FLATFORM_ENTRY`, `USER_POST`, `TANGGAL_POST`, `FLATFORM_POST`, `CATATAN_REVIEW`, `HAS_REVIEW`, `TANGGAL_REVIEW`, `USER_REVIEW`, `FLATFORM_REVIEW`) VALUES
(1, '2019-05-10', 'Rata-rata ICP Bulanan\r\nJan  : 56,55 USD/Barrel. \r\nFeb  : 61,31 USD/Barrel.\r\nMar  : 63,60 USD/Barrel.\r\nRata-rata ICP Bulanan Januari s.d Maret 2019 adalah 60,49 USD/Barrel.\r\nAsumsi APBN 2019 adalah 70 USD/Barrel.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 1, '2019-05-10 12:05:54', 'WEB', 2, '2019-05-10 15:05:16', 'WEB', NULL, NULL, NULL, NULL, NULL),
(2, '2019-07-18', 'Test Laporan ICP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y', 11, '2019-07-19 14:07:57', 'WEB', 9, '2019-07-19 16:07:06', 'WEB', 'jangan pake test', 'Y', '2019-07-19 16:07:48', 7, 'WEB'),
(3, '2019-07-22', 'The IF function returns 1 if the order’s status is canceled, on hold or disputed, otherwise, it returns NULL. The COUNT function only counts 1, not NULL values, therefore, the query returns the number of orders based on the corresponding status.\r\n\r\nmysql count expression\r\n\r\nIn this tutorial, you have learned various techniques to count the number of rows in a table using the MySQL COUNT function.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, '2019-07-23 09:07:53', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `r_lap_pusdatin_lift_tb`
--

CREATE TABLE `r_lap_pusdatin_lift_tb` (
  `ID_LAPORAN` int(11) NOT NULL,
  `TANGGAL_LAPORAN` date DEFAULT NULL,
  `LIFT_MB` text,
  `POSISI_STOCK` text,
...
--
-- Dumping data for table `r_lap_pusdatin_lift_tb`
--

INSERT INTO `r_lap_pusdatin_lift_tb` (`ID_LAPORAN`, `TANGGAL_LAPORAN`, `LIFT_MB`, `POSISI_STOCK`, `SALUR_GAS`, `IS_POST`, `USER_ENTRY`, `TANGGAL_ENTRY`, `FLATFORM_ENTRY`, `USER_POST`, `TANGGAL_POST`, `FLATFORM_POST`, `LIFT_GAS`, `CATATAN_REVIEW`, `HAS_REVIEW`, `TANGGAL_REVIEW`, `USER_REVIEW`, `FLATFORM_REVIEW`) VALUES
(1, '2019-05-10', 'Test', 'Test', 'Test', 'Y', 1, '2019-05-10 12:05:48', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, '2019-07-15', 'test', 'yes', '123', 'Y', 2, '2019-07-16 13:07:56', 'WEB', NULL, NULL, NULL, '22', NULL, NULL, NULL, NULL, NULL),
(3, '2019-07-15', 'Lifting Minyak Bumi\n• Hari ini: 894,84 Mbbls.\n• MTD bln Apr : 561,33 Mbopd\n(Kumulatif lifting April s.d hari ini 12.911 mbbls)\n• YTD Thn 2019: 707,52 Mbopd\n(91,29 %) dari target APBN 2019 sebesar 775 mbopd)\n(Kumulatif lifting tahun 2019 s.d hari ini 79.950 mbbls)', 'Posisi stock hari ini:\r\n•Ready for lifting: 2,88 MMbbls, •Proses settling: 3,58 MMbbls •Stock unpumpable: 3,82 MMbbls', '• Hari ini: 5.698 mmscfd\n• MTD Apr : 5.635 mmscfd\n(Kumulatif salur gas April s.d hari ini 129.615 mmscf)\n• YTD Thn 2019: 5.905 mmscfd (84.36% dari target APBN 2019 sebesar 7.000 mmscfd), dg breakdown penyaluran sbb:\n- melalui gas pipa : 3.746 mmscfd\n- feed gas ke kilang LNG : 2.116 mmscfd - gas ke LPG : 43 mmscfd\nKumulatif salur gas tahun 2019 s.d hari ini 667.301 mmscf.', NULL, 10, '2019-07-17 10:07:47', 'WEB', NULL, NULL, NULL, '0', 'hg bm', NULL, NULL, NULL, NULL),
(4, '2019-07-15', 'Lifting Minyak Bumi\n• Hari ini: 894,84 Mbbls.\n• MTD bln Apr : 561,33 Mbopd\n(Kumulatif lifting April s.d hari ini 12.911 mbbls)\n• YTD Thn 2019: 707,52 Mbopd\n(91,29 %) dari target APBN 2019 sebesar 775 mbopd)\n(Kumulatif lifting tahun 2019 s.d hari ini 79.950 mbbls)', 'Posisi stock hari ini:\r\n•Ready for lifting: 2,88 MMbbls, •Proses settling: 3,58 MMbbls •Stock unpumpable: 3,82 MMbbls\r\n', 'Salur Gas:\n• Hari ini: 5.698 mmscfd\n• MTD Apr : 5.635 mmscfd\n(Kumulatif salur gas April s.d hari ini 129.615 mmscf)\n• YTD Thn 2019: 5.905 mmscfd (84.36% dari target APBN 2019 sebesar 7.000 mmscfd), dg breakdown penyaluran sbb:\n- melalui gas pipa : 3.746 mmscfd\n- feed gas ke kilang LNG : 2.116 mmscfd - gas ke LPG : 43 mmscfd\nKumulatif salur gas tahun 2019 s.d hari ini 667.301 mmscf.', NULL, 10, '2019-07-17 10:07:23', 'WEB', NULL, NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL),
(5, '2019-07-20', 'jkasdkj', NULL, 'WERTY', 'Y', 2, '2019-07-21 20:07:02', 'WEB', 9, '2019-07-21 23:07:27', 'WEB', 'WERHJ', NULL, 'Y', '2019-07-21 23:07:44', 2, 'WEB');

-- --------------------------------------------------------

--
-- Table structure for table `r_lap_pusdatin_prod_ekui_migas`
--

CREATE TABLE `r_lap_pusdatin_prod_ekui_migas` (
  `ID_LAPORAN` int(11) NOT NULL,
  `TANGGAL_LAPORAN` date DEFAULT NULL,
...
--
-- Dumping data for table `r_lap_pusdatin_prod_ekui_migas`
--

INSERT INTO `r_lap_pusdatin_prod_ekui_migas` (`ID_LAPORAN`, `TANGGAL_LAPORAN`, `PROD_HARIAN`, `PROD_BULANAN`, `PROD_TAHUNAN`, `APBN`, `IS_POST`, `USER_ENTRY`, `TANGGAL_ENTRY`, `FLATFORM_ENTRY`, `USER_POST`, `TANGGAL_POST`, `FLATFORM_POST`, `CATATAN_REVIEW`, `HAS_REVIEW`, `TANGGAL_REVIEW`, `USER_REVIEW`, `FLATFORM_REVIEW`) VALUES
(1, '2019-05-10', 3, 5, 5, 7, 'Y', 1, '2019-05-10 11:05:28', 'WEB', 2, '2019-05-10 15:05:33', 'WEB', NULL, NULL, NULL, NULL, NULL),
(2, '2019-07-20', 234567, 12345, 123456, 123498, 'Y', 2, '2019-07-21 15:07:29', 'WEB', 9, '2019-07-21 15:07:20', 'WEB', NULL, 'Y', '2019-07-21 15:07:13', 2, 'WEB'),
(3, '2019-07-20', 0, 0, 0, 0, NULL, 2, '2019-07-21 15:07:16', 'WEB', NULL, NULL, NULL, 'fghjg', NULL, NULL, NULL, NULL),
(4, '2019-07-20', 0, 0, 0, 0, NULL, 2, '2019-07-21 15:07:37', 'WEB', NULL, NULL, NULL, 'gbmj', NULL, NULL, NULL, NULL),
(5, '2019-07-20', 23456, 2345, 87654, 3456, NULL, 2, '2019-07-21 15:07:19', 'WEB', NULL, NULL, NULL, 'asdsad', NULL, NULL, NULL, NULL),
(6, '2019-07-24', 1234567890, 2341234567, 5412345679, 876523456, NULL, 2, '2019-07-25 10:07:05', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `r_lap_pusdatin_prod_gas`
--

CREATE TABLE `r_lap_pusdatin_prod_gas` (
  `ID_LAPORAN` int(11) NOT NULL,
  `TANGGAL_LAPORAN` date DEFAULT NULL,
  `PROD_HARIAN` double(12,0) DEFAULT NULL,
  `PROD_BULANAN` double(12,0) DEFAULT NULL,
...
--
-- Dumping data for table `r_lap_pusdatin_prod_gas`
--

INSERT INTO `r_lap_pusdatin_prod_gas` (`ID_LAPORAN`, `TANGGAL_LAPORAN`, `PROD_HARIAN`, `PROD_BULANAN`, `PROD_TAHUNAN`, `APBN`, `IS_POST`, `USER_ENTRY`, `TANGGAL_ENTRY`, `FLATFORM_ENTRY`, `USER_POST`, `TANGGAL_POST`, `FLATFORM_POST`, `CATATAN_REVIEW`, `HAS_REVIEW`, `TANGGAL_REVIEW`, `USER_REVIEW`, `FLATFORM_REVIEW`) VALUES
(1, '2019-05-10', 3, 4, 5, 6, 'Y', 1, '2019-05-10 11:05:14', 'WEB', 2, '2019-05-12 03:05:21', 'WEB', NULL, NULL, NULL, NULL, NULL),
(2, '2019-07-14', 12, 13, 11, 12, 'Y', 2, '2019-07-15 11:07:03', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, '2019-07-20', 20000, 20000, 10000, 20000, 'Y', 2, '2019-07-21 09:07:37', 'WEB', 9, '2019-07-21 12:07:42', 'WEB', NULL, 'Y', '2019-07-21 12:07:14', 2, 'WEB'),
(4, '2019-07-24', 200000, 212121, 144444, 123456789012, NULL, 2, '2019-07-25 10:07:20', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `r_lap_pusdatin_prod_minyak`
--

CREATE TABLE `r_lap_pusdatin_prod_minyak` (
  `ID_LAPORAN` int(11) NOT NULL,
  `TANGGAL_LAPORAN` date DEFAULT NULL,
  `PROD_HARIAN` double(12,0) DEFAULT NULL,
  `PROD_BULANAN` double(12,0) DEFAULT NULL,
...
--
-- Dumping data for table `r_lap_pusdatin_prod_minyak`
--

INSERT INTO `r_lap_pusdatin_prod_minyak` (`ID_LAPORAN`, `TANGGAL_LAPORAN`, `PROD_HARIAN`, `PROD_BULANAN`, `PROD_TAHUNAN`, `APBN`, `IS_POST`, `USER_ENTRY`, `TANGGAL_ENTRY`, `FLATFORM_ENTRY`, `USER_POST`, `TANGGAL_POST`, `FLATFORM_POST`, `CATATAN_REVIEW`, `HAS_REVIEW`, `USER_REVIEW`, `TANGGAL_REVIEW`, `FLATFORM_REVIEW`) VALUES
(22, '2019-07-17', 222222, 222222, 222222, 600000000, NULL, 11, '2019-07-18 14:07:38', 'WEB', NULL, NULL, NULL, 'czx', NULL, NULL, NULL, NULL),
(23, '2019-07-17', 100000, 100000, 100000, 600000000, 'Y', 11, '2019-07-18 15:07:38', 'WEB', 9, '2019-07-20 11:07:41', 'WEB', 'TEST', 'Y', 7, '2019-07-18 18:07:02', 'WEB'),
(25, '2019-07-19', 20000, 50000, 40000, 600000000, 'Y', 11, '2019-07-20 07:07:28', 'WEB', 9, '2019-07-22 05:07:01', 'WEB', NULL, 'Y', 2, '2019-07-22 05:07:08', 'WEB'),
(27, '2019-07-21', 0, 0, 0, 600000000, NULL, 2, '2019-07-22 13:07:19', 'WEB', NULL, NULL, NULL, NULL, 'Y', 7, '2019-08-01 17:08:22', 'WEB'),
(28, '1970-01-01', 20000, 20000, 12345678, 600000000, NULL, 2, '2019-07-23 08:07:23', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(29, '1970-01-01', 20000, 20000, 12345678, 600000000, NULL, 2, '2019-07-23 08:07:30', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(30, '1970-01-01', 20000, 20000, 12345678, 600000000, NULL, 2, '2019-07-23 08:07:30', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(31, '2019-07-22', 200000, 123123, 69131, 600000000, NULL, 2, '2019-07-23 09:07:26', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(32, '2019-07-22', 20000, 20000, 20000, 600000000, NULL, 2, '2019-07-23 09:07:31', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(33, '2019-07-22', 22222, 123123, 365212, 600000000, NULL, 2, '2019-07-23 13:07:44', 'WEB', NULL, NULL, NULL, 'yap', NULL, NULL, NULL, NULL),
(34, '2019-07-25', 23456, 12345, 2345, 600000000, NULL, 2, '2019-07-26 10:07:34', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(35, NULL, 2200000, 2220000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `r_lap_pusdatin_prog_peny_prem_jamali`
--

CREATE TABLE `r_lap_pusdatin_prog_peny_prem_jamali` (
  `ID_LAPORAN` int(11) NOT NULL,
  `TANGGAL_LAPORAN` date DEFAULT NULL,
  `PROGRES` text,
  `CATATAN` text,
...
--
-- Dumping data for table `r_lap_pusdatin_prog_peny_prem_jamali`
--

INSERT INTO `r_lap_pusdatin_prog_peny_prem_jamali` (`ID_LAPORAN`, `TANGGAL_LAPORAN`, `PROGRES`, `CATATAN`, `IS_POST`, `USER_ENTRY`, `TANGGAL_ENTRY`, `FLATFORM_ENTRY`, `USER_POST`, `TANGGAL_POST`, `FLATFORM_POST`, `CATATAN_REVIEW`, `HAS_REVIEW`, `TANGGAL_REVIEW`, `USER_REVIEW`, `FLATFORM_REVIEW`) VALUES
(1, '2019-05-31', 'Tet', 'Tttt', 'Y', 1, '2019-05-10 12:05:24', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `r_lap_pusdatin_stts_tl`
--

CREATE TABLE `r_lap_pusdatin_stts_tl` (
  `ID_LAPORAN` int(11) NOT NULL,
  `TANGGAL_LAPORAN` date DEFAULT NULL,
  `STATUS` text,
  `IS_POST` char(1) DEFAULT NULL,
...
--
-- Dumping data for table `r_lap_pusdatin_stts_tl`
--

INSERT INTO `r_lap_pusdatin_stts_tl` (`ID_LAPORAN`, `TANGGAL_LAPORAN`, `STATUS`, `IS_POST`, `USER_ENTRY`, `TANGGAL_ENTRY`, `FLATFORM_ENTRY`, `USER_POST`, `TANGGAL_POST`, `FLATFORM_POST`, `CATATAN_REVIEW`, `HAS_REVIEW`, `TANGGAL_REVIEW`, `USER_REVIEW`, `FLATFORM_REVIEW`) VALUES
(1, '2019-05-17', 'Tet', 'Y', 1, '2019-05-10 12:05:22', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, '2019-07-13', 'fdghv', 'Y', 2, '2019-07-14 16:07:35', 'WEB', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
-- Table structure for table `t_gunung`
--

CREATE TABLE `t_gunung` (
...
--
-- Dumping data for table `t_gunung`
--
...
--
-- Table structure for table `t_hak_akses_role`
--

CREATE TABLE `t_hak_akses_role` (
...
--
-- Dumping data for table `t_hak_akses_role`
--
...
--
-- Table structure for table `t_jenis_berita`
--

CREATE TABLE `t_jenis_berita` (
  `ID_JENIS_BERITA` int(11) NOT NULL,
  `JENIS_BERITA` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `t_jenis_berita`
--
...
--
-- Table structure for table `t_jenis_laporan`
--

CREATE TABLE `t_jenis_laporan` (
...
--
-- Dumping data for table `t_jenis_laporan`
--
...
--
-- Table structure for table `t_kabkot`
--

CREATE TABLE `t_kabkot` (
...
--
-- Dumping data for table `t_kabkot`
--
...
CREATE TABLE `t_target` (
  ...
  `APBN_PROD_MINYAK` double(12,0) DEFAULT NULL,
  `APBN_PROD_GAS` double(12,0) DEFAULT NULL,
  `APBN_EKV_MIGAS` double(12,0) DEFAULT NULL,
...
INSERT INTO `t_target` (`ID_TARGET`, `APBN_PROD_MINYAK`, `APBN_PROD_GAS`, `APBN_EKV_MIGAS`, `TAHUN`) VALUES
(3, 123456, 34567, 98765, 2019),
(4, 600000000, 20000000, 100000000, 2019);
...
CREATE TABLE `t_user` (
  ...
  `IS_REVIEW` char(1) DEFAULT NULL,
  `IS_ENTRY` char(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `t_user` (`ID_USER`, `USERNAME`, `ID_ROLE`, `PASSWORD`, `NAMA_USER`, `IS_POST`, `TGL_LOGIN`, `IS_REVIEW`, `IS_ENTRY`) VALUES
(2, 'admin', 1, '202cb962ac59075b964b07152d234b70', 'Admin', 'Y', '2019-08-05 10:13:06', 'Y', 'Y'),
(5, 'samuel', 2, '202cb962ac59075b964b07152d234b70', 'Samuel', 'T', NULL, NULL, NULL),
(6, 'tile', 2, '202cb962ac59075b964b07152d234b70', 'ardian', 'Y', NULL, NULL, NULL),
(7, 'antonbudi', 6, '202cb962ac59075b964b07152d234b70', 'Kasubid', 'T', NULL, 'Y', 'T'),
(9, 'farida', 8, '202cb962ac59075b964b07152d234b70', 'Kabid', 'Y', NULL, 'T', 'T'),
(10, 'yusuf', 9, '202cb962ac59075b964b07152d234b70', 'Yusuf', 'T', '2019-07-17 08:12:44', 'T', 'Y'),
(12, 'admin_psd', 10, '202cb962ac59075b964b07152d234b70', 'si ADMIN PUSDATIN', 'Y', NULL, 'Y', NULL),
(13, 'admin_geo', 11, '202cb962ac59075b964b07152d234b70', 'GEO', 'Y', NULL, 'Y', NULL),
(14, 'admin_berita', 12, '202cb962ac59075b964b07152d234b70', 'admberita', 'Y', NULL, 'Y', NULL),
(15, 'entry_berita', 13, '202cb962ac59075b964b07152d234b70', 'Entry Berita', 'T', '2019-08-01 20:10:00', 'T', 'T'),
(17, 'test_berita', 13, '202cb962ac59075b964b07152d234b70', 'Tester Berita', 'T', NULL, 'T', 'T'),
(32, 'Wamen', 6, '202cb962ac59075b964b07152d234b70', 'Pak Wamen', 'T', NULL, 'Y', 'T'),
(33, 'user_berita', 13, '202cb962ac59075b964b07152d234b70', 'Tester Berita', 'T', NULL, 'T', 'Y'),
(34, 'entry_geologi', 15, '202cb962ac59075b964b07152d234b70', 'Aku Entry Berita', 'T', '2019-08-01 19:21:30', 'T', 'Y'),
(35, 'entry_pusdatin', 16, '202cb962ac59075b964b07152d234b70', 'Aku Entry Pusdatin', 'T', NULL, 'T', 'Y');
...
--
-- Indexes for table `r_lap_berita_hot_news`
--
ALTER TABLE `r_lap_berita_hot_news`
  ADD PRIMARY KEY (`ID_LAPORAN`);

--
-- Indexes for table `r_lap_berita_negatif`
--
ALTER TABLE `r_lap_berita_negatif`
  ADD PRIMARY KEY (`ID_LAPORAN`);

--
-- Indexes for table `r_lap_berita_netral`
--
ALTER TABLE `r_lap_berita_netral`
  ADD PRIMARY KEY (`ID_LAPORAN`);
...
ALTER TABLE `t_jenis_laporan`
  ...
  ADD KEY `FK_REFERENCE_4` (`ID_KATEGORI`);
...
ALTER TABLE `t_user`
  ...
  ADD KEY `FK_REFERENCE_1` (`ID_ROLE`);
...
--
-- AUTO_INCREMENT for table `r_lap_berita_hot_news`
--
ALTER TABLE `r_lap_berita_hot_news`
  MODIFY `ID_LAPORAN` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `r_lap_berita_negatif`
--
ALTER TABLE `r_lap_berita_negatif`
  MODIFY `ID_LAPORAN` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `r_lap_berita_netral`
--
ALTER TABLE `r_lap_berita_netral`
...
--
ALTER TABLE `t_hak_akses_role`
  MODIFY `ID_HAK_AKSES` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
...
--
ALTER TABLE `t_jenis_laporan`
  MODIFY `ID_JENIS_LAPORAN` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `t_role`
  MODIFY `ID_ROLE` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `t_user`
  MODIFY `ID_USER` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
-- Constraints for table `r_lap_geologi_gunung_api`
--
ALTER TABLE `r_lap_geologi_gunung_api`
...
--
-- Constraints for table `t_jenis_laporan`
--
ALTER TABLE `t_jenis_laporan`
