									...
									<div class="profile-info-row">
										...
										<div class="profile-info-value">
											<div class="input-group">
                                                ...
                                                <button  type="button" class="btn btn-success btn-minier" onclick="EbtkeGet()" id="select-gunung">Show Before</button> 
											</div>
										</div>
									</div>
...
function EbtkeGet(){
	...
	$.ajax({
		...
		url: "<?php echo site_url('Lap_klik/showBeforeDateEbtke'); ?>",
		data: {
			"tanggal": tanggal
		},
