									...
									<div class="profile-info-row">
										...
										<div class="profile-info-value">
											<div class="input-group">
                                                ...
                                                <button  type="button" class="btn btn-success btn-minier" onclick="MigasGet()" id="select-gunung">Show Before</button>  
											</div>
										</div>
									</div>
...
function MigasGet(){
	...
	$.ajax({
		...
		url: "<?php echo site_url('Lap_klik/showBeforeDateMigas'); ?>",
		data: {
			"tanggal": tanggal
		},
