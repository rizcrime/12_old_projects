							...
							<div class="col-xs-12 col-sm-9">
								<div class="profile-user-info profile-user-info-striped">
									<div class="profile-info-row">
										...
										<div class="profile-info-value">
											<div class="input-group">
                                                ...
                                                <button  type="button" class="btn btn-success btn-minier" onclick="gerakanTanahGet()">Show Before</button> 
											</div>
										</div>
									</div>
									...
									<div class="profile-info-row">
										...
										<div class="profile-info-value">
											<textarea required class="form-control" type="text" name="KETERANGAN" id="KETERANGAN" placeholder="Keterangan" style="resize: vertical;"></textarea>
										</div>
									</div>
  ...
  // Submit upload
    $('#upload').submit(function(e) {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url('Lap_geologi/prosesUploadGerakanTanah'); ?>',
            data: formData,
            processData: false,
            contentType: false
        })
...
// End Submit upload  
  ...
  function gerakanTanahGet(){
	...
	$.ajax({
		...
		url: "<?php echo site_url('Lap_geologi/showBeforeDateGerakanTanah'); ?>",
		data: {
			"tanggal": tanggal
		},
