<form id="form-update-draft-gerakantanah" method="POST">
<?=get_csrf_token()?>
<div class="modal-content" style="border-radius: 10px">
  ...
  <div class="modal-body">
    ...
    <div class="profile-user-info profile-user-info-striped">
      <div class="profile-info-row">
        <div class="profile-info-name" style="min-width: 200PX">Keterangan</div>

        
        
        <div class="profile-info-value">
        	<textarea class="form-control" type="text" name="KETERANGAN" id="KETERANGAN"
                            style="width: 100%;min-height:80px;" placeholder="Keterangan"><?php echo $datanya[0]->KETERANGAN; ?></textarea>
      ...
      <div class="profile-info-row">
        ...
        <div class="profile-info-value">
        	<textarea class="form-control" type="text" name="DETAIL" id="DETAIL"
                            style="width: 100%;min-height:80px;" placeholder="Detail"><?php echo $datanya[0]->DETAIL; ?></textarea>
