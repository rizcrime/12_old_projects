<div class="modal-content" style="border-radius: 10px">
  <div class="modal-header" style="background-color:SteelBlue; color:white;border-radius: 10px 10px 0 0;">
    ...
    <h4 class="modal-title" style="text-align: center;"><i class="fa fa-warning" style="color: #fff000"></i> <strong>Perhatian</h4>
  </div>
  <form id="modal-form-setuju" method="POST" action="<?php echo base_url('Permohonan_izin_atas/prosesSetuju')?>">
  <?=get_csrf_token()?>
