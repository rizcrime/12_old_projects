<form id="form-update-draft-liftingtb" method="POST">
<?=get_csrf_token()?>
<div class="modal-content" style="border-radius: 10px">
  ...
  <div class="modal-body">
    ...
    <div class="profile-user-info profile-user-info-striped">
      ...
      <div class="profile-info-row">
        <div class="profile-info-name" style="min-width: 200PX">Lifting Minyak Bumi        </div>
        <div class="profile-info-value">
          <textarea class="form-control" type="text" name="LIFT_MB" id="LIFT_MB"
                            style="width: 100%;min-height:100px;" placeholder="Lifting Minyak Bumi"><?php echo $datanya[0]->LIFT_MB; ?></textarea>
        </div>
      </div>
      ...
      <div class="profile-info-row">
        ...
        <div class="profile-info-value">
          <textarea class="form-control" type="text" name="SALUR_GAS" id="SALUR_GAS"
                            style="width: 100%;min-height:100px;" placeholder="Salur Gas"><?php echo $datanya[0]->SALUR_GAS; ?></textarea>
        </div>
      </div>
      
      <div class="profile-info-row">
        <div class="profile-info-name" style="min-width: 200PX">Lifting Migas</div>
        <div class="profile-info-value">
          <textarea class="form-control" type="text" name="LIFT_GAS" id="LIFT_GAS"
                            style="width: 100%;min-height:100px;" placeholder="Lifting Migas"><?php echo $datanya[0]->LIFT_GAS; ?></textarea>
        </div>
      </div>
      
      <!--<div class="profile-info-row">
        <div class="profile-info-name" style="min-width: 200PX">
          Posisi Stock hari ini</div>

        <div class="profile-info-value">
          <textarea class="form-control" type="text" name="POSISI_STOCK" id="POSISI_STOCK"
                            style="width: 100%;min-height:100px;" placeholder="Posisi Stock hari ini"><?php echo $datanya[0]->POSISI_STOCK; ?></textarea>
        </div>
      </div>-->
