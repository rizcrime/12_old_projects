...
<?=get_csrf_token()?>						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="profile-user-info profile-user-info-striped">
									...
									<div class="profile-info-row">
										<div class="profile-info-name"> Produksi Gas Harian (MMSCFD)</div>
									...
									<div class="profile-info-row">
										<div class="profile-info-name"> Rata - rata Produksi Bulanan (MMSCFD)</div>
									...
									<div class="profile-info-row">
										<div class="profile-info-name"> Rata - rata Produksi Tahunan (MMSCFD)</div>
									...
									<div class="profile-info-row">
										<div class="profile-info-name"> Target APBN (MMSCFD)</div>
    ...
    $dataTahunTargetProdMinyak = $this->db->query("SELECT APBN_PROD_GAS from t_target where TAHUN = '".date('Y')."' ORDER BY ID_TARGET DESC limit 1");
      $no=1;
      foreach ($dataTahunTargetProdMinyak->result_array() as $row)
    {
    ?>
											<input required class="form-control" type="number" name="APBN" id="APBN" value="<?php echo $row['APBN_PROD_GAS'] ?>" readonly>
                                            <?php } ?>
										</div>
									</div>
