				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						<div class="page-header">
							<h1>Status Ketenagalistrikan </h1>
						</div>
                    </div>
                 </div>
             </div>   
							...
							<div class="col-xs-12 col-sm-9">
								<div class="profile-user-info profile-user-info-striped">
									<div class="profile-info-row">
										...
										<div class="profile-info-value">
											<div class="input-group">
                                                ...
                                                <button  type="button" class="btn btn-success btn-minier" onclick="StatusGatrikGet()" id="select-gunung">Show Before</button>
											</div>
										</div>
									</div>
									...
									<div class="profile-info-row">
										...
										<div class="profile-info-value">
											<textarea required class="form-control" type="text" name="STATUS" id="STATUS" placeholder="Status" style="width: 80%;min-height:88px;" ></textarea>
										</div>
									</div>
...
// Submit upload
    $('#upload').submit(function(e) {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url('Lap_pusdatin/prosesUploadGatrik'); ?>',
            data: formData,
            processData: false,
            contentType: false
        })
...
function StatusGatrikGet(){
	...
	$.ajax({
		...
		url: "<?php echo site_url('Lap_pusdatin/showBeforeDateStatusGatrik'); ?>",
		data: {
			"tanggal": tanggal
		},
		success: function(response){
			...
			$('textarea[name="STATUS"]').val(response.status);	
		},
