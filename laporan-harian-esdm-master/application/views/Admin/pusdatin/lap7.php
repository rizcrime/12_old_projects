...
foreach ($dataSet as $data) {
  ...
  <tr>
    ...
    <td><?=nl2br(htmlspecialchars($data->PROGRES))?></td>
    <td><?=nl2br(htmlspecialchars($data->CATATAN))?></td>
    <td class="text-center" style="min-width:230px;">
    <?php if($IS_REVIEW == 'Y'){ ?>
    	<button class="btn btn-warning update-dataDraftJamali btn-minier" data-id="<?php echo $data->ID_LAPORAN; ?>" data-jenis="<?php echo 7 ?>"><i class="glyphicon glyphicon-repeat"></i> Update</button>
    <?php } ?>
