<form id="form-update-draft-jamali" method="POST">
<?=get_csrf_token()?>
<div class="modal-content" style="border-radius: 10px">
  ...
  <div class="modal-body">
    ...
    <div class="profile-user-info profile-user-info-striped">
      <div class="profile-info-row">
        <div class="profile-info-name" style="min-width: 200PX">Progress</div>

        
        
        <div class="profile-info-value">
        	<textarea class="form-control" type="text" name="PROGRES" id="PROGRES"
                            style="width: 100%;min-height:100px;" placeholder="Progress"><?php echo $datanya[0]->PROGRES; ?></textarea>
            
        </div>
      </div>
      
      <div class="profile-info-row">
        <div class="profile-info-name" style="min-width: 200PX">Catatan</div>

        
        
        <div class="profile-info-value">
        	<textarea class="form-control" type="text" name="CATATAN" id="CATATAN"
                            style="width: 100%;min-height:100px;" placeholder="Catatan"><?php echo $datanya[0]->CATATAN; ?></textarea>
