<form id="form-update-draft-harga-bb-acuan" method="POST">
<?=get_csrf_token()?>
  ...
  <div class="modal-body">
    ...
    <div class="profile-info-row">
                    <div class="profile-info-name" style="min-width: 200PX">
                        ID Laporan Harga Batubara Acuan
                    </div>
     ...
     <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                    <textarea class="form-control" type="text" name="HARGA" id="HARGA"
                            style="width: 100%;min-height:100px;" placeholder="Harga"><?php echo $datanya[0]->HARGA; ?></textarea>   
