<form id="form-update-draft-stts-tl" method="POST">
<?=get_csrf_token()?>
  ...
  <div class="modal-body">
    ...
    <div class="profile-user-info profile-user-info-striped">
      ...
      <div class="profile-info-row">
        ...
        <div class="profile-info-value">
        	<textarea class="form-control" type="text" name="STATUS" id="STATUS"
                            style="width: 100%;min-height:80px;" placeholder="Status"><?php echo $datanya[0]->STATUS; ?></textarea>
