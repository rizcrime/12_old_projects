          ...
          <ul class="steps">
            ...
            <li data-step="3">
              <!-- 
                ...
                menambahkan href dan menambahkan style pada span class=step
              -->
              <a href="<?php echo base_url()?>Permohonan_izin_eval/step4/<?php echo $bidder->ID_PERUSAHAAN?>" style="display: block; cursor: auto;">
            ...
            <li data-step="4" >
              <!-- 
                ...
                menambahkan href dan menambahkan style pada span class=step
              -->
              <a href="<?php echo base_url()?>Permohonan_izin_eval/step5/<?php echo $bidder->ID_PERUSAHAAN?>" style="display: block; cursor: auto;">
...
<div style="overflow:auto;">
  <div style="float:left;">
    <a class="btn-sm btn-danger" href="<?php echo site_url('Permohonan_izin_eval') ?>" style="color: white"><i class="fa fa-times"></i> Cancel</a>
    <div style="float:right;">&nbsp
    <a href="<?php echo base_url()?>Permohonan_izin_eval/step5/<?php echo $bidder->ID_PERUSAHAAN?>" class="btn-sm btn-info"><i class="fa fa-chevron-left"></i> Kembali</a>
  </div>
