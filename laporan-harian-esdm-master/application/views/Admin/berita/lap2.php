...
foreach ($dataEntry as $data) {
  ...
  <tr>
    ...
    <button class="btn btn-warning update-dataDraftBeritaNegatif btn-minier" data-id="<?php echo $data->ID_LAPORAN; ?>" data-jenis="<?php echo 2 ?>"><i class="glyphicon glyphicon-repeat"></i> Update</button>
    <!--<?php if($IS_POST == 'Y'){ ?>
...
foreach ($dataSet as $data) {
  ...
  <tr>
	...
	<?php if($IS_REVIEW == 'Y'){ ?>
    	<button class="btn btn-primary  review-dataDraftBeritaNegatif btn-minier" data-id="<?php echo $data->ID_LAPORAN; ?>" data-jenis="<?php echo 2 ?>" ><i class="glyphicon fa fa-search" ></i> Review</button>
    <?php } ?>
  ...
  <?php } ?>	
  <a target="_blank" href="<?php echo base_url().'Lap_berita/downloadFileTextNegatif/'.$data->ID_LAPORAN;?>">Download</a>
