...
<!-- content begin -->
            ...
            <tr>
            <td width="20%" align="center" bgcolor="#D0E4FF" class="border" style="padding:0 5 0 5; font-size:14px" colspan="4"><p align="left"style="color: rgb(51,102,255)">1. MIGAS</p></td>
			</tr>
  ...
  <?php              
   ...
   ?>             
            ...
            <tr>
            <td width="20%" align="center" bgcolor="#D0E4FF" class="border" style="padding:0 5 0 5; font-size:14px" colspan="4"><p align="left"style="color: rgb(51,102,255)">2. MINERBA</p></td>
			</tr>
 ...
 <?php
  ...
  <?php              
   ...
   ?>       
            ...
            <tr>
            <td width="20%" align="center" bgcolor="#D0E4FF" class="border" style="padding:0 5 0 5; font-size:14px" colspan="4"><p align="left"style="color: rgb(51,102,255)">3. KETENAGALISTRIKAN</p></td>
			</tr>
<?php
    //include 'koneksi.php';
   // $mahasiswa = mysqli_query($koneksi, "SELECT * from mahasiswa");
  ...
  <?php              
   ...
   ?>       
   			...
   			<tr>
            <td width="20%" align="center" bgcolor="#D0E4FF" class="border" style="padding:0 5 0 5; font-size:14px" colspan="4"><p align="left"style="color: rgb(51,102,255)">4. EBTKE</p></td>
			</tr>
                <?php
    //include 'koneksi.php';
   // $mahasiswa = mysqli_query($koneksi, "SELECT * from mahasiswa");
	$dataGunung = $this->db->query("SELECT * from r_lap_klik_ebtke");
    $no=1;
    foreach ($dataGunung->result_array() as $row)
	{
        if($jenis = $row['JENIS']=='N'){
