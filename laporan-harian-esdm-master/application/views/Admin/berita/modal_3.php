									...
									<div class="profile-info-row">
										...
										<div class="profile-info-value">
											<div class="input-group">
                                                ...
                                                <button  type="button" class="btn btn-success btn-minier" onclick="PositifGet()" id="select-gunung">Show Before</button> 
											</div>
										</div>
									</div>
...
// Submit upload
    $('#upload').submit(function(e) {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url('Lap_berita/prosesUploadPositif'); ?>',
            data: formData,
            processData: false,
            contentType: false
        })
...
function PositifGet(){
	...
	$.ajax({
		...
		url: "<?php echo site_url('Lap_berita/showBeforeDatePositif'); ?>",
		data: {
			"tanggal": tanggal
		},
