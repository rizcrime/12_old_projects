...
foreach ($dataEntry as $data) {
  ...
  <tr>
    ...
    <button class="btn btn-warning update-dataDraftBeritaNetral btn-minier" data-id="<?php echo $data->ID_LAPORAN; ?>" data-jenis="<?php echo 4 ?>"><i class="glyphicon glyphicon-repeat"></i> Update</button>
...
foreach ($dataSet as $data) {
  ...
  <tr>
    ...
    <?php } ?>
    <?php if($IS_REVIEW == 'Y'){ ?>
    <button class="btn btn-primary review-dataDraftBeritaNetral btn-minier" data-id="<?php echo $data->ID_LAPORAN; ?>" data-jenis="<?php echo 4 ?>"><i class="glyphicon fa fa-search"></i> Review</button>
    <?php } ?>
    <?php if($IS_REVIEW == 'Y'){ ?>
  ...
  <button class="btn btn-danger konfirmasiHapus-target btn-minier" data-id="<?php echo $data->ID_LAPORAN; ?>" data-toggle="modal" data-target="#konfirmasiHapus"><i class="glyphicon glyphicon-remove-sign"></i> Delete
   ...
   <?php } ?>
   <a target="_blank" href="<?php echo base_url().'Lap_berita/downloadFileTextNetral/'.$data->ID_LAPORAN;?>">Download</a>
