							...
							<div class="col-xs-12 col-sm-9">
								<div class="profile-user-info profile-user-info-striped">
									<div class="profile-info-row">
										...
										<div class="profile-info-value">
											<div class="input-group">
                                                ...
                                                <button  type="button" class="btn btn-success btn-minier" onclick="HotNewsGet()" id="select-gunung">Show Before</button>  
											</div>
										</div>
									</div>
									...
									<div class="profile-info-row">
										...
										<div class="profile-info-value">
											<textarea class="form-control" type="text" name="BERITA" id="BERITA" placeholder="Berita" style="resize: vertical;"></textarea>
										</div>
									</div>
   ...
   // Submit upload
    $('#upload').submit(function(e) {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url('Lap_geologi/prosesUploadMinerba'); ?>',
            data: formData,
            processData: false,
            contentType: false
        })
...
function HotNewsGet(){
	...
	$.ajax({
		...
		url: "<?php echo site_url('Lap_berita/showBeforeDateHotNews'); ?>",
		data: {
			"tanggal": tanggal
		},
...
<script type="text/javascript">
  ...
  $('#form-tambah').submit(function(e) {
    ...
    $.ajax({
      method: 'POST',
      url: '<?php echo base_url('Lap_berita/prosesTambah'); ?>',
      data: formData,
      processData: false,
            contentType: false
    })
