...
if(isset($_GET["taskId"]) and isset($_GET["instanceId"])) {
	...
	if(isset($_POST["reevaluate"])) {
		...
		echo "<h5><a href='tasklistEselon2.php'>Back</a></h5>";
	} 
...
<H2>Form Pengesahan izin Usaha Pertambangan</H2><br/> 
...
Catatan Eselon 2:<br/><textarea name="catatanEselon2" ><?php echo $data->catatanEselon2;?></textarea><br/><br/>
Catatan Eselon 3:<br/><textarea name="catatanEselon3"  disabled="disabled"><?php echo $data->catatanEselon3;?></textarea><br/><br/>
...
<input type="submit" name="submit" value="Sahkan" />
</form>
