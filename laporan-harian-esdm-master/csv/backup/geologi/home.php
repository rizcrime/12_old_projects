        ...
        <a  href="#1" data-toggle="tab">Entry Laporan</a>
            ...
            <li>
                <div class="profile-info-row" style="text-align: right;">
                                                <button class="btn btn-info pull-right" id="btnTampilkan">
            ...
            <button class="btn btn-success konfirmasiPost-admin pull-right" data-toggle="modal" data-target="#konfirmasiPost"><i class="glyphicon glyphicon-ok"></i> POST</button> 
          	</div>
		</ul>
