...
<tr bgcolor="efefef">
  ...
  ?>
                ...
                <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4">	<div align="left">Produksi Minyak Harian Tanggal <?php echo date('d M Y')?> : <?php echo $row['PROD_HARIAN']?> BOPD</div></td>
                ...
                <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4">Rata - rata Produksi Bulanan : <?php echo $row['PROD_BULANAN']?> BOPD</td>
                </tr>
               
                
                <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4">Rata - rata Produksi Tahunan : <?php echo $row['PROD_TAHUNAN']?> BOPD</td>
                </tr>
                
                
                <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4">Target APBN : <?php echo $row['APBN']?> BOPD</td>
                </tr>
  ...
  ?>
               ...
               <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4">	<div align="left">Produksi Harian Gas Tanggal <?php echo date('d M Y')?> : <?php echo $row['PROD_HARIAN']?> MMSCFD</div></td>
                ...
                <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4">Rata - rata Produksi Bulanan : <?php echo $row['PROD_BULANAN']?> MMSCFD</td>
                </tr>
               
                
                <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4">Rata - rata Produksi Tahunan : <?php echo $row['PROD_TAHUNAN']?> MMSCFD</td>
                </tr>
                <tr><td height="1" colspan="4" bgcolor='#aaafff'></td></tr>
  ...
  ?>
               ...
               <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4">	<div align="left">Produksi Harian Tanggal <?php echo date('d M Y')?> : <?php echo $row['PROD_HARIAN']?> BOEPD</div></td>
                ...
                <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4">Rata - rata Produksi Bulanan : <?php echo $row['PROD_BULANAN']?> BOEPD</td>
                </tr>
               
                
                <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4">Rata - rata Produksi Tahunan : <?php echo $row['PROD_TAHUNAN']?> BOEPD</td>
                </tr>
                
                
                <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4">Target Lifting APBN : <?php echo $row['APBN']?> BOEPD</td>
                </tr>
                <tr><td height="1" colspan="4" bgcolor='#aaafff'></td></tr>
  ...
  ?>
               ...
               <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4">LIFTING MINYAK BUMI :</td>
                    
                </tr>
                <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4"><?php echo $row['LIFT_MB']?></td>
                </tr>
                
                <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4">POSISI STOCK HARI INI :</td>
                </tr>
                <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5">
                ...
                <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4">SALUR GASI :</td>
                </tr>
                <tr bgcolor="efefef">
  ...
  ?>
               ...
               <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4">A. JENIS BBM TERTENTU</td>
                    
                </tr>
                <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4"><?php echo $row['JENIS_TERTENTU']?></td>
                </tr>
                
                <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4">B. JENIS BBM UMUM</td>
                </tr>
                <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5">
                ...
                <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4">C. PROGRAM INDONESIA SATU HARGA</td>
                </tr>
                <tr bgcolor="efefef">
                ...
                <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4">D. PER NEGARA:</td>
                </tr>
                <tr bgcolor="efefef">
  ...
  ?>
               ...
               <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4">PROGRES :</td>
                    
                </tr>
                <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4"><?php echo $row['PROGRES']?></td>
                </tr>
                
                <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4">CATATAN :</td>
                </tr>
                <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5">
  ...
  ?>
               ...
               <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4">BERITA :</td>
                    
                </tr>
                <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4"><?php echo $row['BERITA']?></td>
                </tr>
                <tr><td height="1" colspan="4" bgcolor='#aaafff'></td></tr>
  ...
  ?>
               ...
               <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4"><?php echo $urutan?>. Harga : <?php echo $row['HARGA']?></td>
                    
                </tr>
                
                <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4">Sumber :</td>
                    
                </tr>
                <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4"><?php echo $row['SUMBER']?></td>
                </tr>
                <tr><td height="1" colspan="4" bgcolor='#aaafff'></td></tr>
  ...
  ?>
                ...
                <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4">STATUS :</td>
                    
                </tr>
                <tr bgcolor="efefef">
                    <td width="100%" style="padding:0 5 0 5" colspan="4"><?php echo $row['STATUS']?></td>
                </tr>
                <tr><td height="1" colspan="4" bgcolor='#aaafff'></td></tr>
