<!--<footer class="main-footer" style="background-color:#003399">-->
<footer>
	<!-- To the right -->
	<!--<div class="pull-center hidden-xs" style="text-align:center">
		<strong style="color:white;" >
        <p style="color:white; font-size:18px">
        Copyright © PUSDATIN <?php echo date('Y')?> - ESDM
        </p>
        </strong>
	</div>-->
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12 black text-center">
							...
							<p class="darklinks fontsize_12" style="line-height: 1.5em; font-size:14px">
								...
								<span style="color: #ffffff"><i class="fa fa-envelope"></i> migas@esdm.go.id</span>
							</p>
						</div>
					</div>
				</div>
	...
	<!-- Default to the left -->
	<!-- strong style="text-align:center">Laporan Harian ESDM -->
</footer>
