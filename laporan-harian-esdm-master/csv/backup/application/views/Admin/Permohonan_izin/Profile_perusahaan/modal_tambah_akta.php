        ...
        <div class="modal-body">
          <div class="profile-user-info profile-user-info-striped">
            ...
            <div class="profile-info-row">
              ...
              <div class="profile-info-value">
                <input type="date" class="form-control" name="TANGGAL_AKTA_DATE" aria-describedby="sizing-addon2" required oninvalid="this.setCustomValidity('Tanggal Akta tidak boleh kosong')" oninput="setCustomValidity('')" max='<?=date("Y-m-d")?>'>
              </div>
            </div>
            ...
            <div class="profile-info-row">
              ...
              <div class="profile-info-value">
                <input type="text" id="NOMOR_SK" name="NOMOR_PENGESAHAN_TEXT" oninvalid="this.setCustomValidity('Nomor SK tidak boleh kosong')" oninput="setCustomValidity('')"  placeholder="Nomor SK Kumham" style="width: 100%;">
              </div>
            </div>
            ...
            <div class="profile-info-row">
              ...
              <div class="profile-info-value">
                <input type="date" class="form-control" name="TANGGAL_PENGESAHAN_DATE" aria-describedby="sizing-addon2" required oninvalid="this.setCustomValidity('Tanggal SK Kumham tidak boleh kosong')" oninput="setCustomValidity('')" max='<?=date("Y-m-d")?>'>
              </div>
            </div>
            ...
            <div class="profile-info-row">
              ...
              <div class="profile-info-value">
                <input type="file" class="form-control" flag="input-file" name="AKTA_FILE" aria-describedby="sizing-addon2" required oninvalid="this.setCustomValidity('File harus dicantumkan')" oninput="setCustomValidity('')" accept=".pdf,.jpg,.jpeg,.png">
              </div>
            </div>
            ...
            <div class="profile-info-row">
              ...
              <div class="profile-info-value">
                <input type="file" class="form-control" flag="input-file" name="PENGESAHAN_FILE" aria-describedby="sizing-addon2" required oninvalid="this.setCustomValidity('File harus dicantumkan')" oninput="setCustomValidity('')" accept=".pdf,.jpg,.jpeg,.png">
              </div>
            </div>
          </div>
        </div>  
