  ...
  <div class="box-body">
    ...
    <div style="overflow:auto;">
      ...
      <div style="float:right;">
        <!-- <i class="btn-sm btn-info" class="fa fa-chevron-left"></i> Kembali</a> -->
        ...
        <a class="btn-sm btn-success" style="color: white" href="<?php echo base_url()?>Permohonan_izin/step5/<?php echo $bidder->ID_PERUSAHAAN?>">Berikutnya <i class="fa fa-chevron-right"></i></a>
      </div>
    </div>
    </form>
  </div>
