        ...
        <div class="modal-body">
          <div class="profile-user-info profile-user-info-striped">
            ...
            <div class="profile-info-row">
              ...
              <div class="profile-info-value">
                <input type="date" class="form-control" name="TANGGAL_AKTA_DATE" aria-describedby="sizing-addon2" required oninvalid="this.setCustomValidity('Tanggal Akta tidak boleh kosong')" oninput="setCustomValidity('')" value="<?php echo $dataAkta->TGL_AKTA; ?>" max='<?=date("Y-m-d")?>'>
              </div>
            </div>
            ...
            <div class="profile-info-row">
              ...
              <div class="profile-info-value">
                <input type="text" id="NOMOR_SK" name="NOMOR_PENGESAHAN_TEXT" oninvalid="this.setCustomValidity('Nomor SK tidak boleh kosong')" oninput="setCustomValidity('')"  placeholder="Nomor SK Kumham" style="width: 100%;" value="<?php echo $dataAkta->NO_PENGESAHAN; ?>">
              </div>
            </div>
            ...
            <div class="profile-info-row">
              ...
              <div class="profile-info-value">
                <input type="date" class="form-control" name="TANGGAL_PENGESAHAN_DATE" aria-describedby="sizing-addon2" required oninvalid="this.setCustomValidity('Tanggal SK Kumham tidak boleh kosong')" oninput="setCustomValidity('')" value="<?php echo $dataAkta->TGL_PENGESAHAN; ?>" max='<?=date("Y-m-d")?>'>
              </div>
            </div>
            ...
            <div class="profile-info-row">
              ...
              <div class="profile-info-value">
                <input type="file" class="form-control" name="AKTA_FILE" aria-describedby="sizing-addon2"  oninvalid="this.setCustomValidity('File harus dicantumkan')"  oninput="setCustomValidity('')" accept=".pdf,.jpg,.jpeg,.png">
            ...
            <div class="profile-info-row">
              ...
              <div class="profile-info-value">
                <input type="file" class="form-control" name="PENGESAHAN_FILE" aria-describedby="sizing-addon2"   oninvalid="this.setCustomValidity('File harus dicantumkan')" oninput="setCustomValidity('')" accept=".pdf,.jpg,.jpeg,.png">
