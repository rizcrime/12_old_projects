...
if(isset($_GET["taskId"]) and isset($_GET["instanceId"])) {
	...
	if(isset($_POST["submit"])) {
		...
		if ($finishTask->status == "200") {	
			echo "Data has been submited to Eselon 3<br/>";	
	...
	if(isset($_POST["reevaluate"])) {
		...
		echo "<h5><a href='tasklistEselon4.php'>Back</a></h5>";
	} 
...
Catatan Eselon 4:<br/><textarea name="catatanEselon4" ><?php echo $data->catatanEselon4;?></textarea><br/><br/>
