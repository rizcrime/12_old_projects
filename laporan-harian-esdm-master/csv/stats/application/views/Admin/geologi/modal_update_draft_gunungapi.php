<form id="form-update-draft-gunungapi" method="POST">
    ...
    <div class="modal-content" style="border-radius: 10px">
        ...
        <div class="modal-body">
            ...
            <input type="hidden" name="ID_LAPORAN" value="<?php echo $datanya[0]->ID_LAPORAN; ?>">
            ...
            <div class="profile-user-info profile-user-info-striped">
                <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                        <input class="form-control" type="text" name="ID_LAPORAN"
            ...
            <div class="profile-user-info profile-user-info-striped">
                <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                        <input class="form-control" type="text" name="NAMA_GUNUNG"
            ...
            <div class="profile-user-info profile-user-info-striped">
                <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                        <textarea class="form-control" type="text" name="REKOMENDASI"
            ...
            <div class="profile-user-info profile-user-info-striped">
                <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                        <textarea class="form-control" type="text" name="VONA"
