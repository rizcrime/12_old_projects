...
<div class="box">
	<div id="exTab2" class="box">
		<ul class="nav nav-tabs">
			<?php if( $userdata->IS_REVIEW == "T" || $userdata->IS_REVIEW == NULL || $userdata->IS_APPROVE == "T" || $userdata->IS_APPROVE == NULL) { ?>
			<li class="active">
				<a href="#2" data-toggle="tab">Draf</a>
			</li>
			<li>
				<a href="#3" data-toggle="tab">History</a>
			</li>
			<?php } else { ?>
			<li class="active">
				<a href="#2" data-toggle="tab">Draf</a>
			...
			<li>
				<div class="profile-info-row" style="text-align: right;">
					<button class="form-control btn btn-primary" data-toggle="modal" data-target="#tambah-gunung" style="margin-left:20px;">
			...
			<div class="profile-info-row" style="text-align: right;">
				...
				<button class="form-control btn btn-primary" data-toggle="modal" data-target="#konfirmasiPost" style="margin-left:20px;"><i
										...
										<div class="col-xs-12 col-sm-9">
											<div class="profile-user-info profile-user-info-striped">
												...
												<div class="profile-user-info profile-user-info-striped"
													style="border: none;">
													<div class="profile-info-row" style="text-align: right;">
														<button class="btn btn-success" id="btnTampilkan" style="margin:10px;">
															<i class="ace-icon fa fa-search align-top bigger-125"></i>
															Tampilkan
														</button>
													</div>
