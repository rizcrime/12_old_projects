...
<div class="row">
 ...
 <div style="overflow:auto;">
  ...
  <div style="float:right;">
    <button class="btn btn-info btn-minier"><a href="<?php echo site_url('Permohonan_izin_atas/step5')?>" style="color: white"><i class="fa fa-chevron-left"></i> Kembali</a></button>
    <button class="btn btn-success btn-minier"><a href="<?php echo base_url()?>/Permohonan_izin_atas/setuju/<?php echo $bidder->ID_PERUSAHAAN?>" style="color: white">Berikutnya </a><i class="fa fa-chevron-right"></i></button>
  </div>
</div>
</form>
</div>
