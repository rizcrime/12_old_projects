...
foreach ($dataAkta as $akta) {
  ...
  <tr>
    ...
    <td><a href='<?=base_url("Permohonan_izin_eval/download_dokumen/akta?file={$akta->ID_AKTA}")?>' target="_blank" target="_blank"><?php echo $akta->NOMOR_AKTA; ?></a></td>
    <td><?php echo $akta->NOTARIS; ?></td>
    <td><?php echo $akta->TGL_AKTA; ?></td>
    <td><a href='<?=base_url("Permohonan_izin_eval/download_dokumen/pengesahan?file={$akta->ID_AKTA}")?>' target="_blank"><?php echo $akta->NO_PENGESAHAN; ?></a></td>
