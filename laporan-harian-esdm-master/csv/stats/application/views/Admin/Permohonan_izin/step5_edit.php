...
<div class="row">
  <div class="box-body">
    ...
    <?=form_open("Permohonan_izin/kirimPermohonan", 'id="main-form"')?>
      ...
      <div style="overflow:auto;">
        ...
        <div style="float:right;">
          <a class="btn-sm btn-info" href="<?php echo site_url("Permohonan_izin/step4_edit/{$currentIDPermohonanEdit}") ?>" class="btn-sm btn-info"><i class="fa fa-chevron-left"></i> Kembali</a>
          <button id="izin-next-step" class="btn-sm btn-success" class="btn-sm btn-success">Kirim <i class="fa fa-chevron-right"></i></button>
        </div>
      </div>
    </form>
  </div>
