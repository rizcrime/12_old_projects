...
<div class="modal-content" style="border-radius: 10px">
  <div class="modal-header" style="background-color:SteelBlue; color:white;border-radius: 10px 10px 0 0;">
    ...
    <h4 class="modal-title" style="text-align: center;"><strong>Tambah Data Gunung</strong></h4>
  </div>
    ...
    <div class="profile-user-info profile-user-info-striped">
      ...
      <div class="profile-info-row">
        ...
        <div class="profile-info-value">
          <input required class="form-control" type="text" name="NAMA_GUNUNG" id="" placeholder="Masukkan Gunung" style="width: 100%;">
        </div>
      </div>
      ...
      <div class="profile-info-row">
        <div class="profile-info-name">PROVINSI</div>
            ...
            <div class="profile-info-value">
              <!--<select required class="form-control" name="ID_PROVINSI">
              ...
              <select name="ID_PROVINSI" id="PROVINSI" class="form-control" required>
                  <option value="">--PILIH--</option>
                  <?php foreach($dataProvinsi as $provinsi): ?>
                    <?php if($gunung->ID_PROVINSI != NULL) { ?>
        ...
        <div class="profile-info-name">KABUPATEN / KOTA</div>
            ...
            <div class="profile-info-value">
              <!--<select required class="form-control" name="ID_KABKOT">
                <option value="">--PILIH--</option>
                <?php foreach($dataKabkot as $kabkot): ?>
                  <option value="<?php echo $kabkot->ID_KABKOT ?>"><?php echo $kabkot->NAMA_KABKOT ?></option>
                <?php endforeach ?>
              </select>-->
