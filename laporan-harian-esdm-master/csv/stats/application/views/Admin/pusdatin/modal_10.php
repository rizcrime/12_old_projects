...
<?=get_csrf_token()?>
	<div class="main-container ace-save-state" id="laporan10">
							...
							<div class="col-xs-12 col-sm-9">
								<div class="profile-user-info profile-user-info-striped">
									<div class="profile-info-row">
										...
										<div class="profile-info-value">
											<div class="input-group">
                                                ...
                                                <button  type="button" class="btn btn-success btn-minier" onclick="MineralAcuanGet()" id="select-gunung">Show Before</button>
											</div>
										</div>
									</div>

									<div class="profile-info-row">
										<div class="profile-info-name"> Harga Mineral </div>

										<!--<div class="profile-info-value">
											<textarea required class="form-control" type="text" name="HARGA"  placeholder="Harga" style="resize: vertical;"></textarea>
										</div>-->
                                        
                                        <div class="profile-info-value">
											<input required class="form-control" type="number" name="HARGA" placeholder="Harga">
										</div>
									</div>
									...
									<div class="profile-info-row">
										...
										<div class="profile-info-value">
											<textarea required class="form-control" type="text" name="SUMBER" placeholder="Sumber" style="resize: vertical;"></textarea>
										</div>
									</div>
								</div>
...
function MineralAcuanGet(){
	...
	$.ajax({
		...
		url: "<?php echo site_url('Lap_pusdatin/showBeforeDateMineralAcuan'); ?>",
		data: {
			"tanggal": tanggal
		},
