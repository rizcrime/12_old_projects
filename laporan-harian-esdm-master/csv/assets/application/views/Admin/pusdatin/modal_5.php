							...
							<div class="col-xs-12 col-sm-9">
								<div class="profile-user-info profile-user-info-striped">
									...
									<div class="profile-info-row">
										...
										<div class="profile-info-value">
											<textarea required class="form-control" type="text" name="LIFT_MB" placeholder="Lifting Minyak Bumi" style="resize: vertical;"></textarea>
										</div>
									</div>
									...
									<div class="profile-info-row">
										...
										<div class="profile-info-value">
											<textarea required class="form-control" type="text" name="POSISI_STOCK" placeholder="Posisi Stock hari ini" style="resize: vertical;"></textarea>
										</div>
									</div>
									...
									<div class="profile-info-row">
										...
										<div class="profile-info-value">
											<textarea required class="form-control" type="text" name="SALUR_GAS" placeholder="Salur Gas" style="resize: vertical;"></textarea>
										</div>
									</div>
								</div>
