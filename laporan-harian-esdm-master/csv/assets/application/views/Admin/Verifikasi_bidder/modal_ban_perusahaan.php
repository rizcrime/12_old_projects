<div class="modal-content" style="border-radius: 10px">
  <div class="modal-header" style="background-color:SteelBlue; color:white;border-radius: 10px 10px 0 0;">
    ...
    <h4 class="modal-title" style="text-align: center;"><strong>Alasan Blacklist</strong></h4>
  </div>
  <form method="POST" action="<?php echo base_url('Verifikasi_bidder/proses_ban_perusahaan')?>">
  <?=get_csrf_token()?>
    <input type="hidden" name="ID_PERUSAHAAN" value="<?php echo $admin->ID_PERUSAHAAN; ?>">
    <div class="modal-body">
    <div class="profile-user-info profile-user-info-striped">
      <div class="profile-info-row">
        Nama Perusahaan : <?=$admin->NAMA_PERUSAHAAN?>
      </div>
    </div>
     <div class="profile-user-info profile-user-info-striped">
      <div class="profile-info-row">
