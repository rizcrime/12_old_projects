<script type="text/javascript">
	...
	function tampilProsesSkema() {
		...
		$.get('<?php echo base_url('Skema_proses/tampil/'); ?>'+idSkema, function(data) {
			MyTable.fnDestroy();
	...
	$(document).on("click", ".detail-dataSkema_proses", function() {
		...
		$.ajax({
			method: "POST",
			url: "<?php echo base_url('Skema_proses/detail'); ?>",
			data: "id=" +id
		})
		.done(function(data) {
	...
	$(document).on("click", ".update-dataSkema_proses", function() {
		...
		$.ajax({
			method: "POST",
			url: "<?php echo base_url('Skema_proses/update'); ?>",
			data: "id=" +id
		})
		.done(function(data) {
			$('#tempat-modal').html(data);
	...
	$(document).on("click", ".hapus-dataSkema_proses", function() {
		...
		$.ajax({
			method: "POST",
			url: "<?php echo base_url('Skema_proses/delete'); ?>",
			data: "id=" +id
		})
		.done(function(data) {
	...
	$(document).on('submit', '#form-update-skema_proses', function(e){
		...
		$.ajax({
			method: 'POST',
			url: '<?php echo base_url('Skema_proses/prosesUpdate'); ?>',
			data: formData,
			processData: false,
            contentType: false
		})
	...
	$('#form-tambah-skema_proses').submit(function(e) {
		...
		$.ajax({
			method: 'POST',
			url: '<?php echo base_url('Skema_proses/prosesTambah/'); ?>' + idSkema,
			data: formData,
			processData: false,
            contentType: false
		})
