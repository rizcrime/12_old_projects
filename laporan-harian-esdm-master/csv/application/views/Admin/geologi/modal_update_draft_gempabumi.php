<form id="form-update-draft-gempabumi" method="POST">
<?=get_csrf_token()?>
<div class="modal-content" style="border-radius: 10px">
  ...
  <div class="modal-body">
    ...
    <div class="profile-user-info profile-user-info-striped">
      <div class="profile-info-row">
        <div class="profile-info-name" style="min-width: 200PX">Lokasi Gempa Bumi</div>

        
        
        <div class="profile-info-value">
        	<textarea class="form-control" type="text" name="LOKASI" id="LOKASI"
                            style="width: 100%;min-height:80px;" placeholder="Lokasi Gempa Bumi"><?php echo $datanya[0]->LOKASI; ?></textarea>
            
        </div>
      </div>
      
      <div class="profile-info-row">
        <div class="profile-info-name" style="min-width: 200PX"> Informasi Gempa Bumi</div>

        
        
        <div class="profile-info-value">
        	<textarea class="form-control" type="text" name="INFORMASI" id="INFORMASI"
                            style="width: 100%;min-height:80px;" placeholder="Informasi"><?php echo $datanya[0]->INFORMASI; ?></textarea>
            
        </div>
      </div>
      
      <div class="profile-info-row">
        <div class="profile-info-name" style="min-width: 200PX">Kondisi Geologi Daerah Terdekat</div>

        
        
        <div class="profile-info-value">
        	<textarea class="form-control" type="text" name="KONDISI_GEOLOGI_DT" id="KONDISI_GEOLOGI_DT"
                            style="width: 100%;min-height:80px;" placeholder="Kondisi Geologi Daerah Terdekat"><?php echo $datanya[0]->KONDISI_GEOLOGI_DT; ?></textarea>
            
        </div>
      </div>
      
      <div class="profile-info-row">
        <div class="profile-info-name" style="min-width: 200PX">Penyebab Gempa Bumi</div>

        
        
        <div class="profile-info-value">
        	<textarea class="form-control" type="text" name="PENYEBAB_GEMPA" id="PENYEBAB_GEMPA"
                            style="width: 100%;min-height:80px;" placeholder="Penyebab Gempa Bumi"><?php echo $datanya[0]->PENYEBAB_GEMPA; ?></textarea>
            
        </div>
      </div>
      
      <div class="profile-info-row">
        <div class="profile-info-name" style="min-width: 200PX">Dampak Gempa Bumi</div>

        
        
        <div class="profile-info-value">
        	<textarea class="form-control" type="text" name="DAMPAK_GEMPA" id="DAMPAK_GEMPA"
                            style="width: 100%;min-height:80px;" placeholder="Dampak Gempa Bumi"><?php echo $datanya[0]->DAMPAK_GEMPA; ?></textarea>
            
        </div>
      </div>
      
      <div class="profile-info-row">
        <div class="profile-info-name" style="min-width: 200PX">Rekomendasi</div>

        
        
        <div class="profile-info-value">
        	<textarea class="form-control" type="text" name="REKOMENDASI" id="REKOMENDASI"
                            style="width: 100%;min-height:80px;" placeholder="Rekomendasi"><?php echo $datanya[0]->REKOMENDASI; ?></textarea>
