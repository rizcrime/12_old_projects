<header class="main-header">
    ...
    <!-- Logo -->
    <a href="<?php echo base_url('Home'); ?>" class="logo" style="background: #ffcc56;">
       ...
       <span class="logo-lg" style="background: #ffcc56;"><b style="background: #ffcc56;">Laporan Harian</b></span>
