    ...
    <div class="box-body">
      ...
      <?=get_csrf_token()?>
        <div class="input-group form-group" style="width: 100%; background-color: white; padding: 0 0px 10px 0px; border: solid 1px #3c8dbc; border-radius: 5px;">
          ...
          <div class="col-md-12">
          <a id="button-periksa" href='<?=base_url("Permohonan_izin_atas/periksa_perizinan")?>' class="btn btn-success btn-md"><i class="fa fa-pencil-square-o"></i> <?=$periksa_string?></a>
          <hr>
