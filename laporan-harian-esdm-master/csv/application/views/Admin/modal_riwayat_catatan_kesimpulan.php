<div class="modal-content" style="border-radius: 10px">
  <div class="modal-header" style="background-color:SteelBlue; color:white;border-radius: 10px 10px 0 0;">
    ...
    <h4 class="modal-title" style="text-align: center;"><strong>Riwayat Catatan Kesimpulan</strong></h4>
  </div>
  <div class="modal-body">
    <div class="dialogs">
      ...
      foreach($catatan as $item_catatan):
        ...
        if(trim($item_catatan->CATATAN_SIMPULAN) == "") { continue; } // Do not show empty comment.
        $count_catatan++; 
      ?>
        ...
        <div class="body">
          <div class="name">
            <a href="#"><?=$item_catatan->NAMA?> @ <?=$item_catatan->TGL_CATATAN_SIMPULAN?></a>
            <hr style="margin: 0; border-top: 2px solid #eee !important">
          </div>
          <h6><strong>Uraian:</strong></h6>
          <div class="text"><?=html_entity_decode(isemptyor($item_catatan->CATATAN_SIMPULAN, "-"))?></div>
        </div>
      </div>
      <?php endforeach; ?>
