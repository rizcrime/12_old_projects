...
foreach ($dataSet as $data) {
  ...
  <tr>
    ...
    <button class="btn btn-warning update-dataDraftKlikMinerba btn-minier" data-id="<?php echo $data->ID_LAPORAN; ?>" data-jenis="<?php echo 2 ?>"><i class="glyphicon glyphicon-repeat"></i> Update</button>
    <?php if($IS_POST == 'Y'){ ?>
