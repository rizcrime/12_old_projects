									...
									<div class="profile-info-row">
										...
										<div class="profile-info-value">
											<div class="input-group">
                                                ...
                                                <button  type="button" class="btn btn-success btn-minier" onclick="GatrikGet()" id="select-gunung">Show Before</button> 
											</div>
										</div>
									</div>
...
// Submit upload
    $('#upload').submit(function(e) {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url('Lap_geologi/prosesUploadGatrik'); ?>',
            data: formData,
            processData: false,
            contentType: false
        })
...
function GatrikGet(){
	...
	$.ajax({
		...
		url: "<?php echo site_url('Lap_klik/showBeforeDateGatrik'); ?>",
		data: {
			"tanggal": tanggal
		},
