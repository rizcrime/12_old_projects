							...
							<div class="col-xs-12 col-sm-9">
								<div class="profile-user-info profile-user-info-striped">
									...
									<div class="profile-info-row">
										...
										<div class="profile-info-value">
											<textarea class="form-control" type="text" name="PROG_IND_SATU_HRG" id="PROG_IND_SATU_HRG" placeholder="Program Indonesia Satu Harga" style="resize: vertical;"></textarea>
										</div>
									</div>
									...
									<div class="profile-info-row">
										...
										<div class="profile-info-value">
											<input required class="form-control" type="number" name="HARGA_PERNEGARA" id="HARGA_PERNEGARA" placeholder="Harga Per-negara" style="resize: vertical;">
										</div>
									</div>
								</div>
