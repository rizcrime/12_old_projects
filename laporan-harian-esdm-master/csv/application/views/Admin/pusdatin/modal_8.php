							...
							<div class="col-xs-12 col-sm-9">
								<div class="profile-user-info profile-user-info-striped">
									...
									<div class="profile-info-row">
										...
										<div class="profile-info-value">
											<textarea required class="form-control" type="text" name="BERITA" id="BERITA" placeholder="Berita" style="resize: vertical;"></textarea>
										</div>
									</div>
								</div>
...
// Submit upload
    $('#upload').submit(function(e) {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url('Lap_pusdatin/prosesUploadOpec'); ?>',
            data: formData,
            processData: false,
            contentType: false
        })
