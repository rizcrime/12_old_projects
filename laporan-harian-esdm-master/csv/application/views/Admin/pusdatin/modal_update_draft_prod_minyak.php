<form id="form-update-draft-prodminyak" method="POST">
<?=get_csrf_token()?>
    ...
    <div class="profile-user-info profile-user-info-striped">
      <div class="profile-info-row">
        <div class="profile-info-name" style="min-width: 200PX">
          Produksi Minyak Harian (BOPD)</div>
      ...
      <div class="profile-info-row">
        <div class="profile-info-name" style="min-width: 200PX">
          Rata - rata Produksi Bulanan (BOPD)</div>
      ...
      <div class="profile-info-row">
        <div class="profile-info-name" style="min-width: 200PX">
          Rata - rata Produksi Tahunan (BOPD)</div>
