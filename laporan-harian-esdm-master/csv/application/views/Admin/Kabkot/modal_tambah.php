<form id="form-tambah-kabkot" method="POST">
<?=get_csrf_token()?>
    ...
    <div class="profile-user-info profile-user-info-striped">
      <div class="profile-info-row">
        ...
        <div class="profile-info-value">
          <input class="form-control" type="text" name="NAMA_KABKOT" id="" placeholder="Masukkan Nama..." style="width: 100%;">
        </div>
      </div>
      ...
      <div class="profile-info-row">
        ...
        <div class="profile-info-value">
          <input class="form-control" type="text" name="NAMA_KABKOT_EN" id="" placeholder="Masukkan Nama English..." style="width: 100%;">
        </div>
      </div>
      ...
      <div class="profile-info-row">
        ...
        <div class="profile-info-value">
          <input class="form-control" type="date" name="MULAI_EXIST" style="width: 100%;">
        </div>
      </div>
      ...
      <div class="profile-info-row">
        ...
        <div class="profile-info-value">
          <input class="form-control" type="date" name="AKHIR_EXIST" style="width: 100%;">
        </div>
      </div>
      ...
      <div class="profile-info-row">
        ...
        <div class="profile-info-value">
          <input class="form-control" type="text" name="KODE_NEGARA" placeholder="Masukkan Kode Negara..." style="width: 100%;">
        </div>
      </div>
