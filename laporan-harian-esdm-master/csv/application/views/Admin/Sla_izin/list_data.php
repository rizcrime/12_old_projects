  ...
  <tr>
    ...
    <td><?php echo $mapping_izin->NAMA_FORM; ?></td>
     <td class="text-center" style="min-width:230px;">
      ...
      <button class="btn btn-warning update-dataMapping_izin btn-minier" data-id="<?php echo $mapping_izin->ID_FORM; ?>"><i class="glyphicon glyphicon-repeat"></i> Mapping</button>
