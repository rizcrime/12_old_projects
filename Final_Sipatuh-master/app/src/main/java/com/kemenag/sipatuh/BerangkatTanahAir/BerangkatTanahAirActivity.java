package com.kemenag.sipatuh.BerangkatTanahAir;
...
public class BerangkatTanahAirActivity extends BaseActivity {
...
//    ArrayList<String> listAbsensi = new ArrayList<String>();
    ...
    private static String TAG = BerangkatTanahAirActivity.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_berangkat_tanah_air);
        ...
        this.listAbsensiJamaah.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener(){
            ...
            public boolean onItemLongClick(final AdapterView<?> parent, final View view, final int position, long id){
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(BerangkatTanahAirActivity.this);
...
//                        listAbsensi.add(jamaahList.get(position).getKodePorsi() +"#" + status[0]);
    ...
    private void showDateDialog1(){
        ...
        mTimePicker = new TimePickerDialog(BerangkatTanahAirActivity.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
    ...
    private void requestInitialData() {
        ...
        requestMSConfig("nama_airline", new OnResponseVolley() {
            @Override
            public void processResponse(Object response) {
                ...
                airlineAdapter = new ArrayAdapter<String>(BerangkatTanahAirActivity.this,
        ...
        requestMSConfig("bandara_indo", new OnResponseVolley() {
            @Override
            public void processResponse(Object response) {
                JSONArray jsonArrayRespone = (JSONArray)response;
                ...
                bandaraAdapter = new ArrayAdapter<String>(BerangkatTanahAirActivity.this,
        ...
        private void LoadDataUrut() {
            ...
            String JSON_URL = AppVar.GET_KEBERANGKATAN + "?kd_paket=" + kd_paket + "&keberangkatan_ke=" + noUrut;
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                rencana_airline.setText(ManifestObject.getString("nm_airline_brkt"));
                                aktual_airline.setText(ManifestObject.getString("nm_airline_brkt"));

                                String namaBandara = hashMapBandaraReverse.get(ManifestObject.getString("bandara_brkt"));
    ...
    private void sendWorkPostRequest() {
        ...
        String URL = AppVar.POST_KEBERANGKATAN;
        final ProgressDialog pDialog = new ProgressDialog(this);
        ...
        JsonObjectRequest stringRequest = new JsonObjectRequest(Request.Method.POST,
            ...
            public void onResponse(JSONObject response) {
                ...
                Intent keluar = new Intent(BerangkatTanahAirActivity.this, MainActivity.class);
        ...
        JsonArrayRequest stringRequest = new JsonArrayRequest(Request.Method.GET, JSON_URL, null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        arrayAdapter = new ArrayAdapter<String>(BerangkatTanahAirActivity.this,
