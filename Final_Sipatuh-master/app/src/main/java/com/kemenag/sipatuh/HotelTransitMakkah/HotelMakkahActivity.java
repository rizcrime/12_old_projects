package com.kemenag.sipatuh.HotelTransitMakkah;
...
public class HotelMakkahActivity extends AppCompatActivity {

    HeightListView listAbsensiJamaah, SubjectListView, SubjectListViewHotel;
    ImageView img_drop;
    ...
    private static String TAG = HotelMakkahActivity.class.getSimpleName();
    private EditText kode_paket, no_urut;
    private EditText rencana_tanggal, rencana_hotel;
    private EditText aktual_tanggal, aktual_waktu, aktual_hotel;
    private Button ambilData, simapanData;
    final String[] status = new String[1];
    private ImageView setTanggal, setWaktu, drop_down_hotel;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_transit_makkah);
        ...
        SubjectListViewHotel = findViewById(R.id.list_hotel);
        ...
        drop_down_hotel = (ImageView) findViewById(R.id.drp_down_hotel);
...
//        rencana_waktu = (EditText) findViewById(R.id.waktu_rencana);
        ...
        drop_down_hotel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (SubjectListViewHotel.getVisibility() == View.VISIBLE) {
                    SubjectListViewHotel.setVisibility(View.GONE);
                } else {
                    SubjectListViewHotel.setVisibility(View.VISIBLE);
                }
            }
        });
        ...
        this.listAbsensiJamaah.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener(){
            ...
            public boolean onItemLongClick(final AdapterView<?> parent, final View view, final int position, long id){
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(HotelMakkahActivity.this);
    ...
    private void showDateDialog1(){
        ...
        mTimePicker = new TimePickerDialog(HotelMakkahActivity.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
    ...
    private void LoadDataUrut() {
        ...
        String JSON_URL = AppVar.GET_MEKKAH + "?kd_paket=" +
                kd_paket + "&keberangkatan_ke=" + noUrut;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            rencana_tanggal.setText(ManifestObject.getString("tgl_masuk_transit"));
//                            rencana_waktu.setText(ManifestObject.getString("waktu_berangkat"));
                            rencana_hotel.setText(ManifestObject.getString("hotel_transit"));
                            aktual_hotel.setText(ManifestObject.getString("hotel_transit"));
    ...
    private void sendWorkPostRequest() {
        ...
        try {
            ...
            jsonParams.put("hotel_aktual", aktual_hotel.getText().toString());

            String one = aktual_tanggal.getText().toString();
            String two = aktual_waktu.getText().toString();
            String three = aktual_hotel.getText().toString();
        ...
        JsonObjectRequest stringRequest = new JsonObjectRequest(Request.Method.POST,
            ...
            public void onResponse(JSONObject response) {
                ...
                Intent keluar = new Intent(HotelMakkahActivity.this, MainActivity.class);
        ...
        JsonArrayRequest stringRequest = new JsonArrayRequest(Request.Method.GET, JSON_URL, null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        arrayAdapter = new ArrayAdapter<String>(HotelMakkahActivity.this,
    ...
    public void requesNamaHotel()
    {
        String JSON_URL = AppVar.GET_HOTEL_MAKKAH;
        final ProgressDialog pDialog = new ProgressDialog(this);
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for(int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                listString2.add(dataPaket.getString("description"));
                            } catch (JSONException e) {
                                e.printStackTrace();
                            }
                        }
                        arrayAdapter = new ArrayAdapter<String>(HotelMakkahActivity.this,
                                android.R.layout.simple_dropdown_item_1line, android.R.id.text1, listString2);
                        SubjectListViewHotel.setAdapter(arrayAdapter);
                        SubjectListViewHotel.setOnItemClickListener(new AdapterView.OnItemClickListener()
                        {
                            @Override
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                String Item = parent.getItemAtPosition(position).toString();
                                aktual_hotel.setText(Item);
                            }
                        });
                    }
                },
