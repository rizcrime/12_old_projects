package com.kemenag.sipatuh.KedatanganMadinah;
...
public class KedatanganMadinahActivity extends AppCompatActivity {
...
//    ArrayList<String> listAbsensi = new ArrayList<String>();
    ...
    private static String TAG = KedatanganMadinahActivity.class.getSimpleName();
...
//        rencana_waktu = (EditText) findViewById(R.id.waktu_rencana);
        ...
        this.listAbsensiJamaah.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener(){
            ...
            public boolean onItemLongClick(final AdapterView<?> parent, final View view, final int position, long id){
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(KedatanganMadinahActivity.this);
...
//                        listAbsensi.add(jamaahList.get(position).getKodePorsi() +"#" + status[0]);
    ...
    private void showDateDialog1(){
        ...
        mTimePicker = new TimePickerDialog(KedatanganMadinahActivity.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            rencana_tanggal.setText(ManifestObject.getString("tgl_masuk_madinah"));
//                            rencana_waktu.setText(ManifestObject.getString("waktu_berangkat"));
    ...
    private void sendWorkPostRequest() {
        ...
        JsonObjectRequest stringRequest = new JsonObjectRequest(Request.Method.POST,
            ...
            public void onResponse(JSONObject response) {
                ...
                Intent keluar = new Intent(KedatanganMadinahActivity.this, MainActivity.class);
        ...
        JsonArrayRequest stringRequest = new JsonArrayRequest(Request.Method.GET, JSON_URL, null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        arrayAdapter = new ArrayAdapter<String>(KedatanganMadinahActivity.this,
    ...
    {
        String JSON_URL = AppVar.GET_HOTEL_MADINAH;
        final ProgressDialog pDialog = new ProgressDialog(this);
        pDialog.setMessage("LOADING");
        pDialog.setIndeterminate(false);
        pDialog.setCancelable(true);
