package com.kemenag.sipatuh.KedatanganJeddah;
...
public class KedatanganJeddahActivity extends AppCompatActivity {
...
//    ArrayList<String> listAbsensi = new ArrayList<String>();
    ...
    private static String TAG = KedatanganJeddahActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kedatangan_jeddah);
...
//        rencana_waktu = (EditText) findViewById(R.id.waktu_rencana);
        ...
        this.listAbsensiJamaah.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener(){
            ...
            public boolean onItemLongClick(final AdapterView<?> parent, final View view, final int position, long id){
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(KedatanganJeddahActivity.this);
    ...
    private void showDateDialog1(){
        ...
        mTimePicker = new TimePickerDialog(KedatanganJeddahActivity.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
    ...
    private void LoadDataUrut() {
        ...
        String JSON_URL = AppVar.GET_JEDDAH + "?kd_paket=" + kd_paket + "&keberangkatan_ke=" + noUrut;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            rencana_tanggal.setText(ManifestObject.getString("tgl_masuk_jeddah"));
//                            rencana_waktu.setText(ManifestObject.getString("waktu_berangkat"));
                            rencana_hotel.setText(ManifestObject.getString("akomodasi_3"));
                            aktual_hotel.setText(ManifestObject.getString("akomodasi_3"));
    ...
    private void sendWorkPostRequest() {
        ...
        JsonObjectRequest stringRequest = new JsonObjectRequest(Request.Method.POST,
            ...
            public void onResponse(JSONObject response) {
                ...
                Intent keluar = new Intent(KedatanganJeddahActivity.this, MainActivity.class);
        ...
        JsonArrayRequest stringRequest = new JsonArrayRequest(Request.Method.GET, JSON_URL, null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        arrayAdapter = new ArrayAdapter<String>(KedatanganJeddahActivity.this,
    ...
    {
        String JSON_URL = AppVar.GET_HOTEL_JEDDAH;
        final ProgressDialog pDialog = new ProgressDialog(this);
        pDialog.setMessage("LOADING");
        pDialog.setIndeterminate(false);
        pDialog.setCancelable(true);
