package com.kemenag.sipatuh.KedatanganTarwiyah;
...
public class KedatanganTarwiyah extends AppCompatActivity {
...
//    ArrayList<String> listAbsensi = new ArrayList<String>();
    ...
    private static String TAG = KedatanganTarwiyah.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kedatangan_tarwiyah);
        ...
        this.listAbsensiJamaah.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener(){
            ...
            public boolean onItemLongClick(final AdapterView<?> parent, final View view, final int position, long id){
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(KedatanganTarwiyah.this);
    ...
    private void showDateDialog1(){
        ...
        mTimePicker = new TimePickerDialog(KedatanganTarwiyah.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
    ...
    private void LoadDataUrut() {
        ...
        String JSON_URL = AppVar.GET_TARWIYAH + "?kd_paket=" + kd_paket + "&keberangkatan_ke=" + noUrut;
    ...
    private void sendWorkPostRequest() {
        ...
        String URL = AppVar.POST_TARWIYAH;
        final ProgressDialog pDialog = new ProgressDialog(this);
        ...
        JsonObjectRequest stringRequest = new JsonObjectRequest(Request.Method.POST,
            ...
            public void onResponse(JSONObject response) {
                ...
                Intent keluar = new Intent(KedatanganTarwiyah.this, MainActivity.class);
        ...
        JsonArrayRequest stringRequest = new JsonArrayRequest(Request.Method.GET, JSON_URL, null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        arrayAdapter = new ArrayAdapter<String>(KedatanganTarwiyah.this,
