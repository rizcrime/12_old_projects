package com.kemenag.sipatuh.KedatanganArafah;
...
public class KedatanganArafahActivity extends AppCompatActivity {
...
//    ArrayList<String> listAbsensi = new ArrayList<String>();
    ...
    private static String TAG = KedatanganArafahActivity.class.getSimpleName();
    private EditText kode_paket, no_urut;
    private EditText rencana_flight, rencana_airline, rencana_bandara, rencana_maktab;
    private EditText aktual_tanggal, aktual_waktu, aktual_flight, aktual_airline, aktual_bandara, aktual_maktab;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kedatangan_arafah);
...
//        rencana_waktu = (EditText) findViewById(R.id.waktu_rencana);
        rencana_maktab = (EditText) findViewById(R.id.maktab_rencana);

        aktual_tanggal = (EditText) findViewById(R.id.tgl_aktual);
        aktual_waktu = (EditText) findViewById(R.id.waktu_aktual);
        aktual_maktab = (EditText) findViewById(R.id.maktab_aktual);
        ...
        this.listAbsensiJamaah.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener(){
            ...
            public boolean onItemLongClick(final AdapterView<?> parent, final View view, final int position, long id){
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(KedatanganArafahActivity.this);
    ...
    private void showDateDialog1(){
        ...
        mTimePicker = new TimePickerDialog(KedatanganArafahActivity.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
    ...
    private void LoadDataUrut() {
        ...
        String JSON_URL =  AppVar.GET_ARAFAH + "?kd_paket=" + kd_paket + "&keberangkatan_ke=" + noUrut;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            rencana_maktab.setText(ManifestObject.getString("h_akomodasi_8"));
                            aktual_maktab.setText(ManifestObject.getString("h_akomodasi_8"));
    ...
    private void sendWorkPostRequest() {
        ...
        try {
            ...
            jsonParams.put("hotel", aktual_maktab.getText().toString());

            String one = aktual_tanggal.getText().toString();
            String two = aktual_waktu.getText().toString();
            String three = aktual_maktab.getText().toString();
        ...
        JsonObjectRequest stringRequest = new JsonObjectRequest(Request.Method.POST,
            ...
            public void onResponse(JSONObject response) {
                ...
                Intent keluar = new Intent(KedatanganArafahActivity.this, MainActivity.class);
        ...
        JsonArrayRequest stringRequest = new JsonArrayRequest(Request.Method.GET, JSON_URL, null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        arrayAdapter = new ArrayAdapter<String>(KedatanganArafahActivity.this,
