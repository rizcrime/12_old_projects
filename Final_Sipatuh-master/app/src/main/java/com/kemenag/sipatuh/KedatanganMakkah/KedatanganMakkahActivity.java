package com.kemenag.sipatuh.KedatanganMakkah;
...
public class KedatanganMakkahActivity extends AppCompatActivity {
...
//    ArrayList<String> listAbsensi = new ArrayList<String>();
    ...
    private static String TAG = KedatanganMakkahActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kedatangan_makkah);
        ...
        this.listAbsensiJamaah.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener(){
            ...
            public boolean onItemLongClick(final AdapterView<?> parent, final View view, final int position, long id){
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(KedatanganMakkahActivity.this);
    ...
    private void showDateDialog1(){
        ...
        mTimePicker = new TimePickerDialog(KedatanganMakkahActivity.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            rencana_tanggal.setText(ManifestObject.getString("tgl_masuk_mekkah"));
                            rencana_hotel.setText(ManifestObject.getString("akomodasi_1"));
                            aktual_hotel.setText(ManifestObject.getString("akomodasi_1"));
    ...
    private void sendWorkPostRequest() {
        ...
        JsonObjectRequest stringRequest = new JsonObjectRequest(Request.Method.POST,
            ...
            public void onResponse(JSONObject response) {
                ...
                Intent keluar = new Intent(KedatanganMakkahActivity.this, MainActivity.class);
        ...
        JsonArrayRequest stringRequest = new JsonArrayRequest(Request.Method.GET, JSON_URL, null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        arrayAdapter = new ArrayAdapter<String>(KedatanganMakkahActivity.this,
