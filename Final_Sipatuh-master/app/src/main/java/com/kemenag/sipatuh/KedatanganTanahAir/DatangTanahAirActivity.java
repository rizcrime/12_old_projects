package com.kemenag.sipatuh.KedatanganTanahAir;
...
public class DatangTanahAirActivity extends BaseActivity {

    HeightListView listAbsensiJamaah, SubjectListView, listNamaBandara;
    ImageView img_drop, img_drop3;
    SessionManager session;
    ArrayAdapter arrayAdapter, bandaraAdapter;
...
//    ArrayList<String> listAbsensi = new ArrayList<String>();
    ...
    private static String TAG = DatangTanahAirActivity.class.getSimpleName();
    private EditText kode_paket, no_urut;
    private EditText rencana_tanggal, rencana_waktu, bandara_rencana;
    private EditText aktual_tanggal, aktual_waktu, aktual_bandara;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_datang_tanah_air);
        ...
        bandara_rencana = (EditText) findViewById(R.id.bandara_rencana);
        ...
        this.listAbsensiJamaah.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener(){
            ...
            public boolean onItemLongClick(final AdapterView<?> parent, final View view, final int position, long id){
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(DatangTanahAirActivity.this);
    ...
    private void requestInitialData() {
        ...
        requestMSConfig("bandara_indo", new BaseActivity.OnResponseVolley() {
            @Override
            public void processResponse(Object response) {
                ...
                bandaraAdapter = new ArrayAdapter<String>(DatangTanahAirActivity.this,
    ...
    private void showDateDialog1(){
        ...
        mTimePicker = new TimePickerDialog(DatangTanahAirActivity.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
    ...
    private void LoadDataUrut() {
        ...
        String JSON_URL = AppVar.GET_DATANG_TANAH_AIR + "?kd_paket=" + kd_paket + "&keberangkatan_ke=" + noUrut;
...
//                            rencana_waktu.setText(ManifestObject.getString("waktu_pulang"));
                            ...
                            String namaBandara = hashMapBandaraReverse.get(ManifestObject.getString("bandara_tujuan_pulang"));
                            bandara_rencana.setText(namaBandara);
    ...
    private void sendWorkPostRequest() {
        ...
        String URL = AppVar.POST_DATANG_TANAH_AIR;
        final ProgressDialog pDialog = new ProgressDialog(this);
        ...
        JsonObjectRequest stringRequest = new JsonObjectRequest(Request.Method.POST,
            ...
            public void onResponse(JSONObject response) {
                ...
                Intent keluar = new Intent(DatangTanahAirActivity.this, MainActivity.class);
        ...
        JsonArrayRequest stringRequest = new JsonArrayRequest(Request.Method.GET, JSON_URL, null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        arrayAdapter = new ArrayAdapter<String>(DatangTanahAirActivity.this,
