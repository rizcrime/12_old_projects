...
public class PerformaSiswaActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_performa_siswa);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.logout:
                Intent logout = new Intent(PerformaSiswaActivity.this, LoginActivity.class);
                startActivity(logout);
                Toast.makeText(this, "anda berhasil logout", Toast.LENGTH_SHORT).show();
                finish();
                break;
            case R.id.performa_siswa:
                Intent performa = new Intent(PerformaSiswaActivity.this, PerformaSiswaActivity.class);
                startActivity(performa);
                finish();
                break;
            case R.id.tagihan:
                Intent tagihan = new Intent(PerformaSiswaActivity.this, TagihanPembayaranActivity.class);
                startActivity(tagihan);
                finish();
                break;
            case R.id.presensi_siswa:
                Intent presensi = new Intent(PerformaSiswaActivity.this, PresensiSiswaActivity.class);
                startActivity(presensi);
                finish();
                break;
            case R.id.feedback:
                Intent chat = new Intent(PerformaSiswaActivity.this, SaranKomunikasiActivity.class);
                startActivity(chat);
                finish();
                break;
